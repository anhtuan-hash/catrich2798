...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  value.version = '11.9.2';
  if (file.endsWith('version.json')) value.releaseName = 'Golden Bank & Exam Factory · Production Certified';
  else value.release = 'Golden Bank & Exam Factory · Production Certified';
...
console.log('Version registry synchronized: 11.9.2 · Golden Bank & Exam Factory · Production Certified');
