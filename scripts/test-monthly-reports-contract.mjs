...
const files = {
  ...
  css: fs.readFileSync(new URL('../src/pages/MonthlyReportsWorkspace.css', import.meta.url), 'utf8'),
...
const checks = [
  ...
  ['Monthly report workspace loads its consolidated stylesheet', files.ui.includes("import './MonthlyReportsWorkspace.css';") && files.css.includes('.mr-teacher-shell') && files.css.includes('.mr-report-meta')],
  ['Consolidated stylesheet covers teacher and TTCM report layouts', files.css.includes('.mr-number-table') && files.css.includes('.mr-manager') && files.css.includes('.mr-report-table')],
