...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  value.version = '11.6.36';
  if (file.endsWith('version.json')) value.releaseName = 'Exam Lifecycle';
  else value.release = 'Exam Lifecycle';
...
console.log('Version registry synchronized: 11.6.36 · Exam Lifecycle');
