...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  value.fontLibrary = ['BrianGesco', 'Quicksand', 'MJ Bexdroga', '1FTV Nasi', 'VL Monologue'];
  value.generatedAt = now;
  fs.writeFileSync(file, JSON.stringify(value, null, 2) + '\n');
}

console.log('Version registry synchronized: 11.6.7 · font library');
