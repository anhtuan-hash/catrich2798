...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  value.version = '11.6.33';
  if (file.endsWith('version.json')) value.releaseName = 'Question Bank Runtime Fix';
  else value.release = 'Question Bank Runtime Fix';
...
console.log('Version registry synchronized: 11.6.33 · Question Bank Runtime Fix');
