...
assert.match(index, /attendance-history-mockup-v4\.js\?v=3[\s\S]*attendance-history-v5\.js\?v=4[\s\S]*attendance-history-pixel-v6\.js\?v=2/, 'cleanup-aware History runtimes must load before the pixel-match runtime');
