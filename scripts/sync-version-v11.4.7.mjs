...
const shared={
  version,runtimeCore:'2.4.7',schemaVersion:'11.4.2',requiresSql:true,
...
Object.assign(versionFile,shared,{releaseName:'Grammar Production Workflow V2'});
...
Object.assign(release,shared,{release:'Grammar Production Workflow V2',runtime:'2.4.7',schema:'11.4.2'});
