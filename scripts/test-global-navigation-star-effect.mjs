...
assert.match(starLogo, /const outer = 17\.6 \* scale;/);
assert.match(starLogo, /const inner = 4\.8 \* scale;/);
assert.match(starLogo, /ctx\.shadowBlur = 3\.6 \+ this\.pointerEnergy \* 4\.8;/);
