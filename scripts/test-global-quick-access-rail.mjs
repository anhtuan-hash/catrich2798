...
assert.ok(css.includes('Quick Access left-only + larger scrollbar hotfix'), 'Quick Access must include the larger scrollbar hotfix.');
...
console.log('PASS: Quick Access V4.13.1 permanently locks the rail to the left edge, normalizes legacy right-side settings, enlarges scrollbars for easier dragging, and preserves route memory, themes, classroom mode, workflows, permissions and custom fonts.');
