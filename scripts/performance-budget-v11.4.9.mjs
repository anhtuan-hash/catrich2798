...
const results=[
 ...
 ['Grammar Builder JS chunk',grammarJs.size,190*1024,grammarJs.name],
 ['Grammar Builder CSS chunk',grammarCss.size,120*1024,grammarCss.name],
...
if(failed)process.exit(1);console.log('V11.4.9 performance budget passed.');
