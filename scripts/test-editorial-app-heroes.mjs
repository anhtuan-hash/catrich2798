...
const checks = [
  ...
  ['Cinematic welcome has a dedicated start transition', (files.firstVisitWelcome.includes("root.classList.add('is-starting')") || files.firstVisitWelcome.includes("root?.classList.add('is-starting')")) && welcomeMotionCss.includes('@keyframes brianWelcomeStartFlash')],
