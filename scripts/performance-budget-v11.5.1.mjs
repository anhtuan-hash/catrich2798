...
const results=[
 ...
 ['Grammar Builder JS chunk',grammarJs.size,205*1024,grammarJs.name],
 ['Grammar Builder CSS chunk',grammarCss.size,150*1024,grammarCss.name],
 ['Total CSS',sum(css),1650*1024,`${css.length} files`],
...
if(failed)process.exit(1);console.log('V11.5.1 performance budget passed.');
