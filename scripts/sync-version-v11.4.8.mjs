...
const shared={
  version,runtimeCore:'2.4.8',schemaVersion:'11.4.2',requiresSql:true,
...
Object.assign(versionFile,shared,{releaseName:'Grammar Builder Large Card Workspace'});
...
Object.assign(release,shared,{release:'Grammar Builder Large Card Workspace',runtime:'2.4.8',schema:'11.4.2'});
