...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  Object.assign(value, {
    version: '12.17.0',
    release: 'Modern App Card Gallery',
    releaseName: 'Modern App Card Gallery',
    runtimeCore: '3.6.0',
    uiCore: true,
    ...
    appCardBoardStyle: 'vivid-blue-pastel',
    appCardGridColumnsDesktop: 5,
...
console.log('Version registry synchronized: 12.17.0');
