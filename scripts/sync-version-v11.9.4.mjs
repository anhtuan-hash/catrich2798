...
for (const file of ['public/version.json', 'public/release-manifest.json']) {
  ...
  value.version = '11.9.4';
  value.releaseName = 'Golden Bank & Exam Factory · Production Certified · Permission-Driven Access';
  if (file.endsWith('release-manifest.json')) {
    value.release = 'Golden Bank & Exam Factory · Production Certified · Permission-Driven Access';
  }
...
console.log('Version registry synchronized: 11.9.4 · Golden Bank & Exam Factory · Production Certified · Permission-Driven Access');
