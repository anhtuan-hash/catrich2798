...
const results=[
 ...
 ['Grammar Builder JS chunk',grammarJs.size,180*1024,grammarJs.name],
 ['Grammar Builder CSS chunk',grammarCss.size,80*1024,grammarCss.name],
 ['Total CSS',sum(css),1550*1024,`${css.length} files`],
...
if(failed)process.exit(1);console.log('V11.4.7 performance budget passed.');
