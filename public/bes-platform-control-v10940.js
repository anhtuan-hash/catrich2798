(function bootstrapBESPlatformControl() {
  ...
  var VERSION = '10.94.0';
  var STORAGE_KEY = 'bes-platform-control-v10940';
  var DISABLED_KEY = 'bes-platform-disabled-modules-v10940';
  var MANIFESTS = {
    release: '/bes-release-v10.94.0.json',
    modules: '/bes-modules-v10.94.0.json',
    flags: '/bes-feature-flags-v10.94.0.json',
    migrations: '/bes-migrations-v10.94.0.json',
    build: '/bes-platform-build-v10.94.0.json',
