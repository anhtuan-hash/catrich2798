...
qt.d = (c, t) => {
  for (var e in t)
    qt.o(t, e) && !qt.o(c, e) && Object.defineProperty(c, e, { enumerable: !0, get: t[e] });
};
...
const st = typeof process == "object" && process + "" == "[object process]" && !process.versions.nw && !(process.versions.electron && process.type && process.type !== "browser"), ms = [1, 0, 0, 1, 0, 0], Ce = [1e-3, 0, 0, 1e-3, 0, 0], Vs = 1e7, _e = 1.35, ut = {
  ANY: 1,
  DISPLAY: 2,
  PRINT: 4,
...
function Js(c, t = null, e = null) {
  if (!c)
    return null;
  try {
    if (e && typeof c == "string" && (e.addDefaultProtocol && c.startsWith("www.") && c.match(/\./g)?.length >= 2 && (c = `http://${c}`), e.tryConvertEncoding))
      try {
        c = ii(c);
      } catch {
      }
...
function bs(c) {
  (typeof c != "object" || c?.length === void 0) && H("Invalid argument for bytesToString");
...
class at {
  ...
  static get platform() {
    return typeof navigator < "u" && typeof navigator?.platform == "string" ? F(this, "platform", {
...
const ve = Array.from(Array(256).keys(), (c) => c.toString(16).padStart(2, "0"));
class C {
  static makeHexColor(t, e, s) {
    return `#${ve[t]}${ve[e]}${ve[s]}`;
  }
  ...
  static getAxialAlignedBoundingBox(t, e) {
    const s = this.applyTransform(t, e), i = this.applyTransform(t.slice(2, 4), e), n = this.applyTransform([t[0], t[3]], e), r = this.applyTransform([t[2], t[1]], e);
  ...
  static singularValueDecompose2dScale(t) {
    const e = [t[0], t[2], t[1], t[3]], s = t[0] * e[0] + t[1] * e[2], i = t[0] * e[1] + t[1] * e[3], n = t[2] * e[0] + t[3] * e[2], r = t[2] * e[1] + t[3] * e[3], a = (s + r) / 2, o = Math.sqrt((s + r) ** 2 - 4 * (s * r - n * i)) / 2, l = a + o || 1, h = a - o || 1;
  ...
  static bezierBoundingBox(t, e, s, i, n, r, a, o, l) {
    return l ? (l[0] = Math.min(l[0], t, a), l[1] = Math.min(l[1], e, o), l[2] = Math.max(l[2], t, a), l[3] = Math.max(l[3], e, o)) : l = [Math.min(t, a), Math.min(e, o), Math.max(t, a), Math.max(e, o)], this.#e(t, s, n, a, e, i, r, o, 3 * (-t + 3 * (s - n) + a), 6 * (t - 2 * s + n), 3 * (s - t), l), this.#e(t, s, n, a, e, i, r, o, 3 * (-e + 3 * (i - r) + o), 6 * (e - 2 * i + r), 3 * (i - e), l), l;
  }
}
function ii(c) {
...
let we = null, Je = null;
function ni(c) {
  return we || (we = /([\u00a0\u00b5\u037e\u0eb3\u2000-\u200a\u202f\u2126\ufb00-\ufb04\ufb06\ufb20-\ufb36\ufb38-\ufb3c\ufb3e\ufb40-\ufb41\ufb43-\ufb44\ufb46-\ufba1\ufba4-\ufba9\ufbae-\ufbb1\ufbd3-\ufbdc\ufbde-\ufbe7\ufbea-\ufbf8\ufbfc-\ufbfd\ufc00-\ufc5d\ufc64-\ufcf1\ufcf5-\ufd3d\ufd88\ufdf4\ufdfa-\ufdfb\ufe71\ufe77\ufe79\ufe7b\ufe7d]+)|(\ufb05+)/gu, Je = /* @__PURE__ */ new Map([["ﬅ", "ſt"]])), c.replaceAll(we, (t, e, s) => e ? e.normalize("NFKC") : Je.get(s));
}
function ri() {
...
class Zt {
  constructor({
    ...
    a && (u = -u, f = -f);
    let p, g, b, m;
    h === 0 ? (p = Math.abs(l - t[1]) * s + n, g = Math.abs(o - t[0]) * s + r, b = (t[3] - t[1]) * s, m = (t[2] - t[0]) * s) : (p = Math.abs(o - t[0]) * s + n, g = Math.abs(l - t[1]) * s + r, b = (t[2] - t[0]) * s, m = (t[3] - t[1]) * s), this.transform = [h * s, d * s, u * s, f * s, p - h * s * o - u * s * l, g - d * s * o - f * s * l], this.width = b, this.height = m;
  }
  get rawDims() {
    const {
      userUnit: t,
...
function li(c, t = "document.pdf") {
  if (typeof c != "string")
    return t;
  if (pe(c))
    return D('getPdfFilenameFromUrl: ignore "data:"-URL for performance reasons.'), t;
...
function Be(c) {
  ...
  return c.startsWith("rgb(") ? c.slice(4, -1).split(",").map((t) => parseInt(t)) : c.startsWith("rgba(") ? c.slice(5, -1).split(",").map((t) => parseInt(t)).slice(0, 3) : (D(`Not a valid color format: "${c}"`), [0, 0, 0]);
}
function ci(c) {
...
function It(c, t, e = !1, s = !0) {
  if (t instanceof Zt) {
    const {
      ...
      style: r
    } = c, a = at.isCSSRoundSupported, o = `var(--scale-factor) * ${i}px`, l = `var(--scale-factor) * ${n}px`, h = a ? `round(down, ${o}, var(--scale-round-x, 1px))` : `calc(${o})`, d = a ? `round(down, ${l}, var(--scale-round-y, 1px))` : `calc(${l})`;
...
class Yt {
  ...
  #o(t) {
    this.#s._focusEventsAllowed = !1, ft(t);
  }
  #c(t) {
    this.#s._focusEventsAllowed = !0, ft(t);
  }
  #h(t) {
    const e = this.#s._uiManager._signal;
  ...
  #u() {
    ...
    s.className = "delete", s.tabIndex = 0, s.setAttribute("data-l10n-id", Yt.#n[t]), this.#h(s), s.addEventListener("click", (i) => {
      e.delete();
    }, {
      signal: e._signal
    }), this.#i.append(s);
  ...
  async #i(t, e) {
    ...
    try {
      ...
      if (typeof e == "string" ? (s.url = e, i = await fe(e, "blob")) : e instanceof File ? i = s.file = e : e instanceof Blob && (i = e), i.type === "image/svg+xml") {
        const n = He._isSVGFittingCanvas, r = new FileReader(), a = new Image(), o = new Promise((l, h) => {
          a.onload = () => {
...
class kt {
  ...
  static get _keyboardManager() {
    const t = kt.prototype, e = (r) => r.#B.contains(document.activeElement) && document.activeElement.tagName !== "BUTTON" && r.hasSomethingToControl(), s = (r, {
      target: a
    }) => {
    ...
    return F(this, "_keyboardManager", new te([[["ctrl+a", "mac+meta+a"], t.selectAll, {
      checker: s
      ...
      checker: (r, {
        target: a
      }) => !(a instanceof HTMLButtonElement) && r.#B.contains(a) && !r.isEnterHandled
    }], [[" ", "mac+ "], t.addNewEditorFromKeyboard, {
      checker: (r, {
        target: a
      }) => !(a instanceof HTMLButtonElement) && r.#B.contains(document.activeElement)
  ...
  constructor(t, e, s, i, n, r, a, o, l, h, d, u, f) {
    ...
    this.#B = t, this.#j = e, this.#r = s, this._eventBus = i, i._on("editingaction", this.onEditingAction.bind(this), {
      signal: p
      ...
      signal: p
    }), this.#et(), this.#rt(), this.#q(), this.#n = n.annotationStorage, this.#y = n.filterFactory, this.#G = r, this.#S = a || null, this.#m = o, this.#g = l, this.#b = h, this.#N = d || null, this.viewParameters = {
  ...
  destroy() {
    ...
    for (const t of this.#i.values())
      t.destroy();
    this.#i.clear(), this.#s.clear(), this.#p.clear(), this.#e = null, this.#_.clear(), this.#o.destroy(), this.#r?.destroy(), this.#T?.hide(), this.#T = null, this.#A && (clearTimeout(this.#A), this.#A = null), this.#F && (clearTimeout(this.#F), this.#F = null), this._editorUndoBar?.destroy();
  }
  combinedSignal(t) {
  ...
  get hcmFilter() {
    return F(this, "hcmFilter", this.#G ? this.#y.addHCMFilter(this.#G.foreground, this.#G.background) : "none");
  }
  get direction() {
    return F(this, "direction", getComputedStyle(this.#B).direction);
  }
  get highlightColors() {
    return F(this, "highlightColors", this.#S ? new Map(this.#S.split(",").map((t) => t.split("=").map((e) => e.trim()))) : null);
  }
  ...
  highlightSelection(t = "") {
    ...
    const {
      ...
      focusNode: n,
      focusOffset: r
    } = e, a = e.toString(), l = this.#H(e).closest(".textLayer"), h = this.getSelectionBoxes(l);
    if (!h)
      return;
    e.empty();
    const d = this.#X(l), u = this.#E === L.NONE, f = () => {
  ...
  #Z() {
    ...
    i && (this.#T ||= new di(this), this.#T.show(s, i, this.direction === "ltr"));
  }
  ...
  #tt() {
    const t = document.getSelection();
    if (!t || t.isCollapsed) {
      this.#L && (this.#T?.hide(), this.#L = null, this.#R({
        hasSelectedText: !1
      }));
      return;
    }
    ...
    if (this.#T?.hide(), this.#L = e, this.#R({
      hasSelectedText: !0
    }), !(this.#E !== L.HIGHLIGHT && this.#E !== L.NONE) && (this.#E === L.HIGHLIGHT && this.showAllEditors("highlight", !0, !0), this.#x = this.isShiftKeyDown, !this.isShiftKeyDown)) {
      const n = this.#E === L.HIGHLIGHT ? this.#X(i) : null;
      n?.toggleDrawing();
  ...
  #W(t = "") {
    this.#E === L.HIGHLIGHT ? this.highlightSelection(t) : this.#m && this.#Z();
  }
  #et() {
  ...
  blur() {
    if (this.isShiftKeyDown = !1, this.#x && (this.#x = !1, this.#W("main_toolbar")), !this.hasSelection)
      return;
    const {
      activeElement: t
    } = document;
    for (const e of this.#_)
      if (e.div.contains(t)) {
        this.#M = [e, t], e._focusEventsAllowed = !1;
        break;
      }
  }
  focus() {
    if (!this.#M)
      return;
    const [t, e] = this.#M;
    this.#M = null, e.addEventListener("focusin", () => {
  ...
  keydown(t) {
    !this.isShiftKeyDown && t.key === "Shift" && (this.isShiftKeyDown = !0), this.#E !== L.NONE && !this.isEditorHandlingKeyboard && kt._keyboardManager.exec(this, t);
  }
  keyup(t) {
  ...
  #R(t) {
    Object.entries(t).some(([s, i]) => this.#U[s] !== i) && (this._eventBus.dispatch("annotationeditorstateschanged", {
      source: this,
      details: Object.assign(this.#U, t)
    }), this.#E === L.HIGHLIGHT && t.hasSelectedEditor === !1 && this.#$([[O.HIGHLIGHT_FREE, !0]]));
  }
  #$(t) {
  ...
  addLayer(t) {
    this.#i.set(t.pageIndex, t), this.#w ? t.enable() : t.disable();
  }
  removeLayer(t) {
  ...
  async updateMode(t, e = null, s = !1) {
    if (this.#E !== t && !(this.#I && (await this.#I.promise, !this.#I))) {
      if (this.#I = Promise.withResolvers(), this.#E = t, t === L.NONE) {
    ...
    if (this.#a) {
      switch (t) {
        ...
        case O.HIGHLIGHT_SHOW_ALL:
          ...
          }), (this.#z ||= /* @__PURE__ */ new Map()).set(t, e), this.showAllEditors("highlight", e);
          break;
      }
      for (const s of this.#_)
        s.updateParams(t, e);
  ...
  showAllEditors(t, e, s = !1) {
    ...
    (this.#z?.get(O.HIGHLIGHT_SHOW_ALL) ?? !0) !== e && this.#$([[O.HIGHLIGHT_SHOW_ALL, e]]);
  }
  enableWaiting(t = !1) {
    if (this.#P !== t) {
      this.#P = t;
  ...
  toggleSelected(t) {
    ...
    this.#_.add(t), t.select(), this.#$(t.propertiesToUpdate), this.#R({
      hasSelectedEditor: !0
    });
  }
  setSelected(t) {
    ...
    for (const e of this.#_)
      e !== t && e.unselect();
    this.#_.clear(), this.#_.add(t), t.select(), this.#$(t.propertiesToUpdate), this.#R({
      hasSelectedEditor: !0
    });
  }
  isSelected(t) {
  ...
  unselectAll() {
    if (!(this.#e && (this.#e.commitOrRemove(), this.#E !== L.NONE)) && !this.#h?.commitOrRemove() && this.hasSelection) {
      for (const t of this.#_)
        t.unselect();
      this.#_.clear(), this.#R({
        hasSelectedEditor: !1
  ...
  translateSelectedEditors(t, e, s = !1) {
    ...
    for (const o of r)
      o.translateInPage(t, e);
  }
  setUpDragSession() {
    if (this.hasSelection) {
      this.disableUserSelect(!0), this.#f = /* @__PURE__ */ new Map();
      for (const t of this.#_)
        this.#f.set(t, {
          savedX: t.x,
          savedY: t.y,
  ...
  addChangedExistingAnnotation({
    ...
    (this.#l ||= /* @__PURE__ */ new Map()).set(t, e);
  }
  ...
  renderAnnotationElement(t) {
    ...
    s && (this.#E === L.NONE && !s.hasBeenModified || s.renderAnnotationElement(t));
  }
}
class wt {
  #t = null;
  ...
  static _l10n = null;
  constructor(t) {
    this.#c = t, this.#d = t._uiManager.useNewAltTextFlow, wt.#f ||= Object.freeze({
  ...
  async setGuessedText(t) {
    this.#t === null && (this.#h = t, this.#u = await wt._l10n.get("pdfjs-editor-new-alt-text-generated-alt-text-with-disclaimer", {
      generatedAltText: t
    }), this.#p());
  }
  ...
  async #p() {
    ...
    if (!t)
      return;
    if (this.#d) {
      if (t.classList.toggle("done", !!this.#t), t.setAttribute("data-l10n-id", wt.#f[this.#a]), this.#i?.setAttribute("data-l10n-id", wt.#f[`${this.#a}-label`]), !this.#t) {
        this.#r?.remove();
        return;
      }
    } else {
...
class ge {
  ...
  constructor({
    ...
    this.#t = t, this.#s = s, this.#i = e, this.#r = i, this.#n = n, this.#l = r, this.#h = new AbortController(), this.#o = AbortSignal.any([a, this.#h.signal]), t.addEventListener("touchstart", this.#d.bind(this), {
      passive: !1,
      signal: this.#o
    });
  }
  ...
  #d(t) {
    if (this.#i?.() || t.touches.length < 2)
      return;
    if (!this.#u) {
      this.#u = new AbortController();
      const i = AbortSignal.any([this.#o, this.#u.signal]), n = this.#t, r = {
        signal: i,
        passive: !1
      };
    ...
    if (ft(t), t.touches.length !== 2 || this.#s?.()) {
      this.#c = null;
      return;
    }
    let [e, s] = t.touches;
    e.identifier > s.identifier && ([e, s] = [s, e]), this.#c = {
      touch0X: e.screenX,
      touch0Y: e.screenY,
      touch1X: s.screenX,
      touch1Y: s.screenY
  ...
  #f(t) {
    ...
    const {
      ...
      touch1X: d,
      touch1Y: u
    } = o, f = d - l, p = u - h, g = r - i, b = a - n, m = Math.hypot(g, b) || 1, A = Math.hypot(f, p) || 1;
    if (!this.#e && Math.abs(A - m) <= ge.MIN_TOUCH_DISTANCE_TO_PINCH)
      return;
...
class R {
  ...
  static _colorManager = new $e();
  static _zIndex = 1;
  static _telemetryTimeout = 1e3;
  static get _resizerKeyboardManager() {
    const t = R.prototype._resizeWithKeyboard, e = kt.TRANSLATE_SMALL, s = kt.TRANSLATE_BIG;
    return F(this, "_resizerKeyboardManager", new te([[["ArrowLeft", "mac+ArrowLeft"], t, {
      args: [-e, 0]
  ...
  translateInPage(t, e) {
    this.#a ||= [this.x, this.y, this.width, this.height], this.#k(this.pageDimensions, t, e), this.div.scrollIntoView({
      block: "nearest"
    });
  }
  drag(t, e) {
    this.#a ||= [this.x, this.y, this.width, this.height];
    const {
      div: s,
  ...
  screenToPageTranslation(t, e) {
    return R.#w(t, e, this.parentRotation);
  }
  pageTranslationToScreen(t, e) {
    return R.#w(t, e, 360 - this.parentRotation);
  }
  #P(t) {
    switch (t) {
      case 90: {
  ...
  fixDims() {
    const {
      ...
      height: e,
      width: s
    } = t, i = s.endsWith("%"), n = !this.#l && e.endsWith("%");
    if (i && n)
      return;
  ...
  #C() {
    ...
    for (const s of t) {
      ...
      this.#o.append(i), i.classList.add("resizer", s), i.setAttribute("data-resizer-name", s), i.addEventListener("pointerdown", this.#M.bind(this, s), {
        signal: e
  ...
  #M(t, e) {
    ...
    this._isDraggable = !1, this.#c = [e.screenX, e.screenY];
  ...
  #E(t, e) {
    const [s, i] = this.parentDimensions, n = this.x, r = this.y, a = this.width, o = this.height, l = R.MIN_SIZE / s, h = R.MIN_SIZE / i, d = this.#P(this.rotation), u = (x, P) => [d[0] * x + d[2] * P, d[1] * x + d[3] * P], f = this.#P(360 - this.rotation), p = (x, P) => [f[0] * x + f[2] * P, f[1] * x + f[3] * P];
    let g, b, m = !1, A = !1;
    switch (t) {
      case "topLeft":
        m = !0, g = (x, P) => [0, 0], b = (x, P) => [x, P];
        break;
      case "topMiddle":
        g = (x, P) => [x / 2, 0], b = (x, P) => [x / 2, P];
        break;
      case "topRight":
        m = !0, g = (x, P) => [x, 0], b = (x, P) => [0, P];
        break;
      case "middleRight":
        A = !0, g = (x, P) => [x, P / 2], b = (x, P) => [0, P / 2];
        break;
      case "bottomRight":
        m = !0, g = (x, P) => [x, P], b = (x, P) => [0, 0];
        break;
      case "bottomMiddle":
        g = (x, P) => [x / 2, P], b = (x, P) => [x / 2, 0];
        break;
      case "bottomLeft":
        m = !0, g = (x, P) => [0, P], b = (x, P) => [x, 0];
        break;
      case "middleLeft":
        A = !0, g = (x, P) => [0, P / 2], b = (x, P) => [x, P / 2];
        break;
    }
    const _ = g(a, o), y = b(a, o);
    let v = u(...y);
    const S = R._round(n + v[0]), w = R._round(r + v[1]);
    let T = 1, M = 1, B, N;
    if (e.fromKeyboard)
      ({
        deltaX: B,
      ...
      [B, N] = this.screenToPageTranslation(x - dt, P - _t), this.#c[0] = x, this.#c[1] = P;
    }
    if ([B, N] = p(B / s, N / i), m) {
      const x = Math.hypot(a, o);
      T = M = Math.max(Math.min(Math.hypot(y[0] - _[0] - B, y[1] - _[1] - N) / x, 1 / a, 1 / o), l / a, h / o);
    } else A ? T = Math.max(l, Math.min(1, Math.abs(y[0] - _[0] - B))) / a : M = Math.max(h, Math.min(1, Math.abs(y[1] - _[1] - N))) / o;
    const G = R._round(a * T), q = R._round(o * M);
    v = u(...b(G, q));
    const $ = S - v[0], it = w - v[1];
    this.#a ||= [this.x, this.y, this.width, this.height], this.width = G, this.height = q, this.x = $, this.y = it, this.setDims(s * G, i * q), this.fixAndSetPosition(), this._onResizing();
  }
  _onResizing() {
  }
  altTextFinish() {
  ...
  async addEditToolbar() {
    return this._editToolbar || this.#m ? this._editToolbar : (this._editToolbar = new Yt(this), this.div.append(this._editToolbar.render()), this.#s && await this._editToolbar.addAltText(this.#s), this._editToolbar);
  }
  removeEditToolbar() {
  ...
  async addAltTextButton() {
    this.#s || (wt.initialize(R._l10n), this.#s = new wt(this), this.#t && (this.#s.data = this.#t, this.#t = null), await this.addEditToolbar());
  }
  get altTextData() {
    return this.#s?.data;
  }
  ...
  render() {
    ...
    return this.translate(s, i), le(this, this.div, ["pointerdown"]), this.isResizable && this._uiManager._supportsPinchToZoom && (this.#S ||= new ge({
      container: this.div,
      isPinchingDisabled: () => !this.isSelected,
      onPinchStart: this.#_.bind(this),
  ...
  #L(t, e, s) {
    ...
    if (n === 1)
      return;
    const r = this.#P(this.rotation), a = (S, w) => [r[0] * S + r[2] * w, r[1] * S + r[3] * w], [o, l] = this.parentDimensions, h = this.x, d = this.y, u = this.width, f = this.height, p = R.MIN_SIZE / o, g = R.MIN_SIZE / l;
    n = Math.max(Math.min(n, 1 / u, 1 / f), p / u, g / f);
    const b = R._round(u * n), m = R._round(f * n);
    if (b === u && m === f)
      return;
    this.#a ||= [h, d, u, f];
    const A = a(u / 2, f / 2), _ = R._round(h + A[0]), y = R._round(d + A[1]), v = a(b / 2, m / 2);
    this.x = _ - v[0], this.y = y - v[1], this.width = b, this.height = m, this.setDims(o * b, l * m), this.fixAndSetPosition(), this._onResizing();
  }
  #G() {
  ...
  #U(t) {
    ...
    const i = new AbortController(), n = this._uiManager.combinedSignal(i), r = {
      ...
      i.abort(), this.#r = null, this.#f = !1, this._uiManager.endDragSession() || this.#z(l), s && this._onStopDragging();
    };
    e && (this.#y = t.clientX, this.#A = t.clientY, this.#r = t.pointerId, this.#n = t.pointerType, window.addEventListener("pointermove", (l) => {
      ...
      const [f, p] = this.screenToPageTranslation(h - this.#y, d - this.#A);
      this.#y = h, this.#A = d, this._uiManager.dragSelectedEditors(f, p);
    }, r), window.addEventListener("touchmove", ft, r), window.addEventListener("pointerdown", (l) => {
      l.pointerType === this.#n && (this.#S || l.isPrimary) && a(l), ft(l);
    }, r));
    const o = (l) => {
  ...
  getRect(t, e, s = this.rotation) {
    ...
    switch (s) {
      case 0:
        return [d + l + a, r - u - h - p + o, d + l + f + a, r - u - h + o];
      case 90:
        return [d + h + a, r - u + l + o, d + h + p + a, r - u + l + f + o];
      case 180:
        return [d - l - f + a, r - u + h + o, d - l + a, r - u + h + p + o];
      case 270:
        return [d - h - p + a, r - u - l - f + o, d - h + a, r - u - l + o];
      default:
  ...
  remove() {
    if (this.#u?.abort(), this.#u = null, this.isEmpty() || this.commit(), this.parent ? this.parent.remove(this) : this._uiManager.removeEditor(this), this.#b && (clearTimeout(this.#b), this.#b = null), this.#H(), this.removeEditToolbar(), this.#v) {
  ...
  makeResizable() {
    this.isResizable && (this.#C(), this.#o.classList.remove("hidden"), le(this, this.div, ["keydown"]));
  }
  get toolbarPosition() {
    return null;
  }
  keydown(t) {
    ...
    if (!this.#e) {
      ...
      for (const l of this.#e) {
        ...
        l.setAttribute("role", "spinbutton"), l.addEventListener("keydown", r, {
          ...
          signal: o
        }), l.addEventListener("focus", this.#j.bind(this, h), {
          signal: o
    ...
    if (n !== i) {
      if (n < i)
        for (let a = 0; a < i - n; a++)
          this.#o.append(this.#o.firstChild);
      else if (n > i)
        for (let a = 0; a < n - i; a++)
          this.#o.firstChild.before(this.#o.lastChild);
      let r = 0;
      for (const a of e) {
...
const ts = 3285377520, gt = 4294901760, vt = 65535;
class _s {
  constructor(t) {
  ...
  update(t) {
    ...
    const d = 3432918353, u = 461845907, f = d & vt, p = u & vt;
    for (let g = 0; g < i; g++)
      g & 1 ? (a = r[g], a = a * d & gt | a * f & vt, a = a << 15 | a >>> 17, a = a * u & gt | a * p & vt, l ^= a, l = l << 13 | l >>> 19, l = l * 5 + 3864292196) : (o = r[g], o = o * d & gt | o * f & vt, o = o << 15 | o >>> 17, o = o * u & gt | o * p & vt, h ^= o, h = h << 13 | h >>> 19, h = h * 5 + 3864292196);
    switch (a = 0, n) {
      case 3:
        a ^= e[i * 4 + 2] << 16;
      case 2:
        a ^= e[i * 4 + 1] << 8;
      case 1:
        a ^= e[i * 4], a = a * d & gt | a * f & vt, a = a << 15 | a >>> 17, a = a * u & gt | a * p & vt, i & 1 ? l ^= a : h ^= a;
    }
    this.h1 = l, this.h2 = h;
  }
  hexdigest() {
    let t = this.h1, e = this.h2;
    return t ^= e >>> 1, t = t * 3981806797 & gt | t * 36045 & vt, e = e * 4283543511 & gt | ((e << 16 | t >>> 16) * 2950163797 & gt) >>> 16, t ^= e >>> 1, t = t * 444984403 & gt | t * 60499 & vt, e = e * 3301882366 & gt | ((e << 16 | t >>> 16) * 3120437893 & gt) >>> 16, t ^= e >>> 1, (t >>> 0).toString(16).padStart(8, "0") + (e >>> 0).toString(16).padStart(8, "0");
  }
}
...
class Ge {
  ...
  setValue(t, e) {
    ...
    if (s !== void 0)
      ...
      i = !0, this.#s.set(t, e);
    i && this.#i(), e instanceof R && typeof this.onAnnotationEditor == "function" && this.onAnnotationEditor(e.constructor._type);
  }
  has(t) {
    return this.#s.has(t);
  }
  getAll() {
    return this.#s.size > 0 ? De(this.#s) : null;
  }
  setAll(t) {
  ...
  get serializable() {
    if (this.#s.size === 0)
      return ke;
    const t = /* @__PURE__ */ new Map(), e = new _s(), s = [], i = /* @__PURE__ */ Object.create(null);
    let n = !1;
  ...
  get editorStats() {
    ...
    for (const s of this.#s.values()) {
      ...
      e.has(n) || e.set(n, Object.getPrototypeOf(s).constructor), t ||= /* @__PURE__ */ Object.create(null);
  ...
  get modifiedIds() {
    ...
    const t = [];
    for (const e of this.#s.values())
      !(e instanceof R) || !e.annotationElementId || !e.serialize() || t.push(e.annotationElementId);
    return this.#e = {
      ids: new Set(t),
      hash: t.join(",")
    };
...
class gi {
    ...
    if (this.isFontLoadingAPISupported) {
      ...
      if (s) {
        ...
        try {
          ...
          throw D(`Failed to load font '${s.family}': '${i}'.`), t.disableFontFace = !0, i;
        }
      }
      return;
    }
  ...
  get isSyncFontLoadingSupported() {
    let t = !1;
    return (st || typeof navigator < "u" && typeof navigator?.userAgent == "string" && /Mozilla\/5.0.*?rv:\d+.*? Gecko/.test(navigator.userAgent)) && (t = !0), F(this, "isSyncFontLoadingSupported", t);
  }
  _queueLoadingCallback(t) {
    function e() {
      for (X(!i.done, "completeRequest() cannot be called twice."), i.done = !0; s.length > 0 && s[0].done; ) {
        const n = s.shift();
  ...
  _prepareFontLoadEvent(t, e) {
    ...
    function i(y, v, S, w) {
      const T = y.substring(0, v), M = y.substring(v + S);
      return T + w + M;
    }
    let n, r;
    ...
    function h(y, v) {
      if (++l > 30) {
        D("Load test font never loaded."), v();
        return;
      }
    ...
    for (const y of [t.loadedName, d]) {
      const v = this._document.createElement("span");
      v.textContent = "Hi", v.style.fontFamily = y, _.append(v);
    }
    this._document.body.append(_), h(d, () => {
      _.remove(), e.complete();
    });
  }
}
...
function ht(c) {
  if (c instanceof Pt || c instanceof Te || c instanceof Qt || c instanceof Qe || c instanceof oe || c instanceof ye)
    return c;
  switch (c instanceof Error || typeof c == "object" && c !== null || H('wrapReason: Expected "reason" to be a (possibly cloned) Error.'), c.name) {
    ...
    case "UnknownErrorException":
      return new ye(c.message, c.details);
  }
  return new ye(c.message, c.toString());
}
class Xt {
  #t = new AbortController();
  constructor(t, e, s) {
  ...
  #e({
    ...
    if (t.callback) {
      ...
      if (delete this.callbackCapabilities[s], t.callback === se.DATA)
        i.resolve(t.data);
      else if (t.callback === se.ERROR)
  ...
  #s(t) {
    const e = t.streamId, s = this.sourceName, i = t.sourceName, n = this.comObj, r = this, a = this.actionHandler[t.action], o = {
      ...
      error(l) {
        X(l instanceof Error, "error must have a valid reason"), !this.isCancelled && (this.isCancelled = !0, n.postMessage({
          sourceName: s,
          targetName: i,
          stream: W.ERROR,
          streamId: e,
  ...
  #i(t) {
    ...
    switch (t.stream) {
      ...
      case W.PULL:
        ...
        break;
      case W.ENQUEUE:
        if (X(r, "enqueue should have stream controller"), r.isClosed)
          break;
        r.controller.enqueue(t.chunk);
        break;
      case W.CLOSE:
        if (X(r, "close should have stream controller"), r.isClosed)
          break;
        r.isClosed = !0, r.controller.close(), this.#r(r, e);
        break;
      case W.ERROR:
        X(r, "error should have stream controller"), r.controller.error(ht(t.reason)), this.#r(r, e);
        break;
      case W.CANCEL_COMPLETE:
        t.success ? r.cancelCall.resolve() : r.cancelCall.reject(ht(t.reason)), this.#r(r, e);
        break;
      case W.CANCEL:
        if (!a)
          break;
...
class Ai extends Es {
  ...
  get #h() {
    if (!this.#s) {
      const t = this.#r.createElement("div"), {
        style: e
      } = t;
      e.visibility = "hidden", e.contain = "strict", e.width = e.height = 0, e.position = "absolute", e.top = e.left = 0, e.zIndex = -1;
      const s = this.#r.createElementNS(Et, "svg");
      s.setAttribute("width", 0), s.setAttribute("height", 0), this.#s = this.#r.createElementNS(Et, "defs"), t.append(s), s.append(this.#s), this.#r.body.append(t);
    }
    return this.#s;
  }
  #u(t) {
  ...
  #d(t) {
    if (this.#t === void 0) {
      this.#t = "";
      const e = this.#r.URL;
      e !== this.#r.baseURI && (pe(e) ? D('#createUrl: ignore "data:"-URL for performance reasons.') : this.#t = e.split("#", 1)[0]);
    }
    return `url(${this.#t}#${t})`;
  }
  addFilter(t) {
  ...
  addHCMFilter(t, e) {
    ...
    t = C.makeHexColor(...r);
    const a = this.#y(e);
    if (e = C.makeHexColor(...a), this.#h.style.color = "", t === "#000000" && e === "#ffffff" || t === e)
      return n.url;
  ...
  addHighlightHCMFilter(t, e, s, i, n) {
    ...
    let h = Math.round(0.2126 * o[0] + 0.7152 * o[1] + 0.0722 * o[2]), d = Math.round(0.2126 * l[0] + 0.7152 * l[1] + 0.0722 * l[2]), [u, f] = [i, n].map(this.#y.bind(this));
    d < h && ([h, d, u, f] = [d, h, f, u]), this.#h.style.color = "";
    const p = (m, A, _) => {
      const y = new Array(256), v = (d - h) / _, S = m / 255, w = (A - m) / (255 * _);
      let T = 0;
      for (let M = 0; M <= _; M++) {
        const B = Math.round(h + M * v), N = S + M * w;
        for (let G = T; G <= B; G++)
          y[G] = N;
        T = B + 1;
      }
  ...
  #f(t) {
    const e = this.#r.createElementNS(Et, "feColorMatrix");
  ...
  #p(t) {
    const e = this.#r.createElementNS(Et, "filter");
    return e.setAttribute("color-interpolation-filters", "sRGB"), e.setAttribute("id", t), this.#h.append(e), e;
  }
  #m(t, e, s) {
    const i = this.#r.createElementNS(Et, e);
    i.setAttribute("type", "discrete"), i.setAttribute("tableValues", s), t.append(i);
  }
  #g(t, e, s, i) {
    const n = this.#r.createElementNS(Et, "feComponentTransfer");
    i.append(n), this.#m(n, "feFuncR", t), this.#m(n, "feFuncG", e), this.#m(n, "feFuncB", s);
  }
  #b(t, e) {
    const s = this.#r.createElementNS(Et, "feComponentTransfer");
    e.append(s), this.#m(s, "feFuncA", t);
  }
  #y(t) {
    return this.#h.style.color = t, Be(getComputedStyle(this.#h).getPropertyValue("color"));
  }
}
class xs {
  constructor({
...
class Si extends ze {
  ...
  getPattern(t, e, s, i) {
    ...
    if (i === et.STROKE || i === et.FILL) {
      const r = e.current.getClippedPathBoundingBox(i, U(t)) || [0, 0, 0, 0], a = Math.ceil(r[2] - r[0]) || 1, o = Math.ceil(r[3] - r[1]) || 1, l = e.cachedCanvases.getCanvas("pattern", a, o), h = l.context;
      h.clearRect(0, 0, h.canvas.width, h.canvas.height), h.beginPath(), h.rect(0, 0, h.canvas.width, h.canvas.height), h.translate(-r[0], -r[1]), s = C.transform(s, [1, 0, 0, 1, r[0], r[1]]), h.transform(...e.baseTransform), this.matrix && h.transform(...this.matrix), Re(h, this._bbox), h.fillStyle = this._createGradient(h), h.fill(), n = t.createPattern(l.canvas, "no-repeat");
      const d = new DOMMatrix(s);
      n.setTransform(d);
    } else
      Re(t, this._bbox), n = this._createGradient(t);
    return n;
  }
}
function Se(c, t, e, s, i, n, r, a) {
  ...
  if (p >= A)
    return;
  const _ = l[n], y = l[n + 1], v = l[n + 2], S = l[r], w = l[r + 1], T = l[r + 2], M = l[a], B = l[a + 1], N = l[a + 2], G = Math.round(p), q = Math.round(A);
  let $, it, x, P, dt, _t, St, pt;
  for (let Z = G; Z <= q; Z++) {
    if (Z < b) {
      const z = Z < p ? 0 : (p - Z) / (p - b);
      $ = f - (f - g) * z, it = _ - (_ - S) * z, x = y - (y - w) * z, P = v - (v - T) * z;
    } else {
      let z;
      Z > A ? z = 1 : b === A ? z = 0 : z = (b - Z) / (b - A), $ = g - (g - m) * z, it = S - (S - M) * z, x = w - (w - B) * z, P = T - (T - N) * z;
    }
    let Y;
    Z < p ? Y = 0 : Z > A ? Y = 1 : Y = (p - Z) / (p - A), dt = f - (f - m) * Y, _t = _ - (_ - M) * Y, St = y - (y - B) * Y, pt = v - (v - N) * Y;
    const Ft = Math.round(Math.min($, dt)), Gt = Math.round(Math.max($, dt));
    let ot = d * Z + Ft * 4;
    for (let z = Ft; z <= Gt; z++)
      Y = ($ - z) / ($ - dt), Y < 0 ? Y = 0 : Y > 1 && (Y = 1), h[ot++] = it - (it - _t) * Y | 0, h[ot++] = x - (x - St) * Y | 0, h[ot++] = P - (P - pt) * Y | 0, h[ot++] = 255;
  }
}
function Ei(c, t, e) {
  ...
  switch (t.type) {
    case "lattice":
      ...
      for (n = 0; n < o; n++) {
        let h = n * a;
        for (let d = 0; d < l; d++, h++)
          Se(c, e, s[h], s[h + 1], s[h + a], i[h], i[h + 1], i[h + a]), Se(c, e, s[h + a + 1], s[h + 1], s[h + a], i[h + a + 1], i[h + 1], i[h + a]);
      }
      break;
    case "triangles":
      for (n = 0, r = s.length; n < r; n += 3)
        Se(c, e, s[n], s[n + 1], s[n + 2], i[n], i[n + 1], i[n + 2]);
      break;
    default:
...
class xi extends ze {
  ...
  _createMeshCanvas(t, e, s) {
    const a = Math.floor(this._bounds[0]), o = Math.floor(this._bounds[1]), l = Math.ceil(this._bounds[2]) - a, h = Math.ceil(this._bounds[3]) - o, d = Math.min(Math.ceil(Math.abs(l * t[0] * 1.1)), 3e3), u = Math.min(Math.ceil(Math.abs(h * t[1] * 1.1)), 3e3), f = l / d, p = h / u, g = {
      ...
      scaleX: 1 / f,
      scaleY: 1 / p
    }, b = d + 4, m = u + 4, A = s.getCanvas("mesh", b, m), _ = A.context, y = _.createImageData(d, u);
    if (e) {
      const S = y.data;
      for (let w = 0, T = S.length; w < T; w += 4)
        S[w] = e[0], S[w + 1] = e[1], S[w + 2] = e[2], S[w + 3] = 255;
    }
    for (const S of this._figures)
      Ei(y, S, g);
    return _.putImageData(y, 2, 2), {
      canvas: A.canvas,
      offsetX: a - 2 * f,
      offsetY: o - 2 * p,
      scaleX: f,
  ...
  getPattern(t, e, s, i) {
    ...
    let n;
    if (i === et.SHADING)
      n = C.singularValueDecompose2dScale(U(t));
...
class Ue {
  ...
  createPatternCanvas(t) {
    ...
    const h = e[0], d = e[1], u = e[2], f = e[3], p = u - h, g = f - d, b = C.singularValueDecompose2dScale(this.matrix), m = C.singularValueDecompose2dScale(this.baseTransform), A = b[0] * m[0], _ = b[1] * m[1];
    let y = p, v = g, S = !1, w = !1;
    const T = Math.ceil(o * A), M = Math.ceil(l * _), B = Math.ceil(p * A), N = Math.ceil(g * _);
    T >= B ? y = o : S = !0, M >= N ? v = l : w = !0;
    const G = this.getSizeAndScale(y, this.ctx.canvas.width, A), q = this.getSizeAndScale(v, this.ctx.canvas.height, _), $ = t.cachedCanvases.getCanvas("pattern", G.size, q.size), it = $.context, x = a.createCanvasGraphics(it);
    if (x.groupLevel = t.groupLevel, this.setFillAndStrokeStyleToContext(x, i, r), it.translate(-G.scale * h, -q.scale * d), x.transform(G.scale, 0, 0, q.scale, 0, 0), it.save(), this.clipBbox(x, h, d, u, f), x.baseTransform = U(x.ctx), x.executeOperatorList(s), x.endDrawing(), it.restore(), S || w) {
      const P = $.canvas;
      S && (y = o), w && (v = l);
      const dt = this.getSizeAndScale(y, this.ctx.canvas.width, A), _t = this.getSizeAndScale(v, this.ctx.canvas.height, _), St = dt.size, pt = _t.size, Z = t.cachedCanvases.getCanvas("pattern-workaround", St, pt), Y = Z.context, Ft = S ? Math.floor(p / o) : 0, Gt = w ? Math.floor(g / l) : 0;
      for (let ot = 0; ot <= Ft; ot++)
        for (let z = 0; z <= Gt; z++)
          Y.drawImage(P, St * ot, pt * z, St, pt, 0, 0, St, pt);
      return {
        canvas: Z.canvas,
        scaleX: dt.scale,
        scaleY: _t.scale,
  ...
  getSizeAndScale(t, e, s) {
    const i = Math.max(Ue.MAX_PATTERN_SIZE, e);
    let n = Math.ceil(t * s);
  ...
  clipBbox(t, e, s, i, n) {
    const r = i - e, a = n - s;
    t.ctx.rect(e, s, r, a), t.current.updateRectMinMax(U(t.ctx), [e, s, i, n]), t.clip(), t.endPath();
  }
...
function Pi({
  ...
  const a = at.isLittleEndian ? 4278190080 : 255, [o, l] = r ? [n, a] : [a, n], h = s >> 3, d = s & 7, u = c.length;
...
const is = 16, ns = 100, ki = 15, rs = 10, as = 1e3, ct = 16;
function Ri(c, t) {
...
function ie(c, t, e, s, i, n, r, a, o, l) {
  ...
  if (d === 0 && u === 0) {
    const A = r * h + p, _ = Math.round(A), y = a * f + g, v = Math.round(y), S = (r + o) * h + p, w = Math.abs(Math.round(S) - _) || 1, T = (a + l) * f + g, M = Math.abs(Math.round(T) - v) || 1;
    return c.setTransform(Math.sign(h), 0, 0, Math.sign(f), _, v), c.drawImage(t, e, s, i, n, 0, 0, w, M), c.setTransform(h, d, u, f, p, g), [w, M];
  }
  if (h === 0 && f === 0) {
    const A = a * u + p, _ = Math.round(A), y = r * d + g, v = Math.round(y), S = (a + l) * u + p, w = Math.abs(Math.round(S) - _) || 1, T = (r + o) * d + g, M = Math.abs(Math.round(T) - v) || 1;
    return c.setTransform(0, Math.sign(d), Math.sign(u), 0, _, v), c.drawImage(t, e, s, i, n, 0, 0, M, w), c.setTransform(h, d, u, f, p, g), [M, w];
  }
...
function Ii(c) {
  ...
  let f = 0;
  for (u = 0, d[u] !== 0 && (r[0] = 1, ++f), o = 1; o < t; o++)
    d[u] !== d[u + 1] && (r[o] = d[u] ? 2 : 1, ++f), u++;
  for (d[u] !== 0 && (r[o] = 2, ++f), a = 1; a < e; a++) {
    u = a * h, l = a * n, d[u - h] !== d[u] && (r[l] = d[u] ? 1 : 8, ++f);
    let m = (d[u] ? 4 : 0) + (d[u - h] ? 8 : 0);
    for (o = 1; o < t; o++)
      m = (m >> 2) + (d[u + 1] ? 4 : 0) + (d[u - h + 1] ? 8 : 0), i[m] && (r[l + o] = i[m], ++f), u++;
    if (d[u - h] !== d[u] && (r[l + o] = d[u] ? 2 : 4, ++f), f > s)
      return null;
  }
  for (u = h * (e - 1), l = a * n, d[u] !== 0 && (r[l] = 8, ++f), o = 1; o < t; o++)
    d[u] !== d[u + 1] && (r[l + o] = d[u] ? 4 : 8, ++f), u++;
  if (d[u] !== 0 && (r[l + o] = 4, ++f), f > s)
    return null;
  ...
  for (a = 0; f && a <= e; a++) {
    ...
    do {
      ...
      while (!r[m]);
      const S = r[m];
      S !== 5 && S !== 10 ? (y = S, r[m] = 0) : (y = S & 51 * y >> 4, r[m] &= y >> 2 | y << 2), g.lineTo(m % n, m / n | 0), r[m] || --f;
    } while (_ !== m);
    --a;
  }
...
class os {
  constructor(t, e) {
    this.alphaIsShape = !1, this.fontSize = 0, this.fontSizeScale = 1, this.textMatrix = ms, this.textMatrixScale = 1, this.fontMatrix = Ce, this.leading = 0, this.x = 0, this.y = 0, this.lineX = 0, this.lineY = 0, this.charSpacing = 0, this.wordSpacing = 0, this.textHScale = 1, this.textRenderingMode = tt.FILL, this.textRise = 0, this.fillColor = "#000000", this.strokeColor = "#000000", this.patternFill = !1, this.patternStroke = !1, this.fillAlpha = 1, this.strokeAlpha = 1, this.lineWidth = 1, this.activeSMask = null, this.transferMaps = "none", this.startNewPathAndClipBox([0, 0, t, e]);
  }
  clone() {
  ...
  updatePathMinMax(t, e, s) {
    [e, s] = C.applyTransform([e, s], t), this.minX = Math.min(this.minX, e), this.minY = Math.min(this.minY, s), this.maxX = Math.max(this.maxX, e), this.maxY = Math.max(this.maxY, s);
  }
  updateRectMinMax(t, e) {
    const s = C.applyTransform(e, t), i = C.applyTransform(e.slice(2), t), n = C.applyTransform([e[0], e[3]], t), r = C.applyTransform([e[2], e[1]], t);
...
function ls(c, t) {
  ...
  if (t.kind === ae.GRAYSCALE_1BPP) {
    const b = h.byteLength, m = new Uint32Array(d.buffer, 0, d.byteLength >> 2), A = m.length, _ = s + 7 >> 3, y = 4294967295, v = at.isLittleEndian ? 4278190080 : 255;
    for (u = 0; u < r; u++) {
      for (p = u < n ? ct : i, l = 0, f = 0; f < p; f++) {
        const S = b - o;
        let w = 0;
        const T = S > _ ? s : S * 8 - 7, M = T & -8;
        let B = 0, N = 0;
        for (; w < M; w += 8)
          N = h[o++], m[l++] = N & 128 ? y : v, m[l++] = N & 64 ? y : v, m[l++] = N & 32 ? y : v, m[l++] = N & 16 ? y : v, m[l++] = N & 8 ? y : v, m[l++] = N & 4 ? y : v, m[l++] = N & 2 ? y : v, m[l++] = N & 1 ? y : v;
        for (; w < T; w++)
          B === 0 && (N = h[o++], B = 128), m[l++] = N & B ? y : v, B >>= 1;
      }
      for (; l < A; )
        m[l++] = 0;
    ...
    for (f = 0, g = s * ct * 4, u = 0; u < n; u++)
      d.set(h.subarray(o, o + g)), o += g, c.putImageData(a, 0, f), f += ct;
    u < r && (g = s * i * 4, d.set(h.subarray(o, o + g)), c.putImageData(a, 0, f));
  } else if (t.kind === ae.RGB_24BPP)
    for (p = ct, g = s * p, u = 0; u < r; u++) {
      for (u >= n && (p = i, g = s * p), l = 0, f = g; f--; )
...
const Li = ["butt", "round", "square"], Di = ["miter", "round", "bevel"], Fi = {}, ds = {};
class Ht {
  constructor(t, e, s, i, n, {
    optionalContentConfig: r,
    markedContentStack: a = null
  }, o, l) {
    this.ctx = t, this.current = new os(this.ctx.canvas.width, this.ctx.canvas.height), this.stateStack = [], this.pendingClip = null, this.pendingEOFill = !1, this.res = null, this.xobjs = null, this.commonObjs = e, this.objs = s, this.canvasFactory = i, this.filterFactory = n, this.groupStack = [], this.processingType3 = null, this.baseTransform = null, this.baseTransformStack = [], this.groupLevel = 0, this.smaskStack = [], this.smaskCounter = 0, this.tempSMask = null, this.suspendedCtx = null, this.contentVisible = !0, this.markedContentStack = a || [], this.optionalContentConfig = r, this.cachedCanvases = new Mi(this.canvasFactory), this.cachedPatterns = /* @__PURE__ */ new Map(), this.annotationCanvasMap = o, this.viewportScale = 1, this.outputScaleX = 1, this.outputScaleY = 1, this.pageColors = l, this._cachedScaleForStroking = [-1, 0], this._cachedGetSinglePixelWidth = null, this._cachedBitmapsMap = /* @__PURE__ */ new Map();
  }
  getObject(t, e = null) {
  ...
  executeOperatorList(t, e, s, i) {
    ...
    if (o === a)
      return a;
    const l = o - a > rs && typeof s == "function", h = l ? Date.now() + ki : 0;
    let d = 0;
    ...
    for (; ; ) {
      ...
      if (p = r[a], p !== bt.dependency)
        this[p].apply(this, n[a]);
      else
        for (const g of n[a]) {
  ...
  _createMaskCanvas(t) {
    const e = this.ctx, {
      width: s,
      height: i
    } = t, n = this.current.fillColor, r = this.current.patternFill, a = U(e);
    let o, l, h, d;
    if ((t.bitmap || t.data) && t.count > 1) {
      const T = t.bitmap || t.data.buffer;
      l = JSON.stringify(r ? a : [a.slice(0, 4), n]), o = this._cachedBitmapsMap.get(T), o || (o = /* @__PURE__ */ new Map(), this._cachedBitmapsMap.set(T, o));
      const M = o.get(l);
      if (M && !r) {
    ...
    let u = C.transform(a, [1 / s, 0, 0, -1 / i, 0, 0]);
    u = C.transform(u, [1, 0, 0, 1, 0, -i]);
    const [f, p, g, b] = C.getAxialAlignedBoundingBox([0, 0, s, i], u), m = Math.round(g - f) || 1, A = Math.round(b - p) || 1, _ = this.cachedCanvases.getCanvas("fillCanvas", m, A), y = _.context, v = f, S = p;
    y.translate(-v, -S), y.transform(...u), h || (h = this._scaleImage(d.canvas, yt(y)), h = h.img, o && r && o.set(l, h)), y.imageSmoothingEnabled = cs(U(y), t.interpolate), ie(y, h, 0, 0, h.width, h.height, 0, 0, s, i), y.globalCompositeOperation = "source-in";
    const w = C.transform(yt(y), [1, 0, 0, 1, -v, -S]);
    return y.fillStyle = r ? n.getPattern(e, this, w, et.FILL) : n, y.fillRect(0, 0, s, i), o && !r && (this.cachedCanvases.delete("fillCanvas"), o.set(l, _.canvas)), {
      canvas: _.canvas,
  ...
  beginSMaskMode() {
    ...
    const n = this.ctx;
    n.setTransform(...U(this.suspendedCtx)), Ut(this.suspendedCtx, n), Ri(n, this.suspendedCtx), this.setGState([["BM", "source-over"], ["ca", 1], ["CA", 1]]);
  }
  endSMaskMode() {
    if (!this.inSMaskMode)
  ...
  constructPath(t, e, s) {
    ...
    for (let f = 0, p = 0, g = t.length; f < g; f++)
      switch (t[f] | 0) {
        case bt.rectangle:
          r = e[p++], a = e[p++];
          const b = e[p++], m = e[p++], A = r + b, _ = a + m;
          i.moveTo(r, a), b === 0 || m === 0 ? i.lineTo(A, _) : (i.lineTo(A, a), i.lineTo(A, _), i.lineTo(r, _)), d || n.updateRectMinMax(h, [r, a, A, _]), i.closePath();
          break;
        case bt.moveTo:
  ...
  stroke(t = !0) {
    ...
    e.globalAlpha = this.current.strokeAlpha, this.contentVisible && (typeof s == "object" && s?.getPattern ? (e.save(), e.strokeStyle = s.getPattern(e, this, yt(e), et.STROKE), this.rescaleAndStroke(!1), e.restore()) : this.rescaleAndStroke(!0)), t && this.consumePath(this.current.getClippedPathBoundingBox()), e.globalAlpha = this.current.fillAlpha;
  }
  closeStroke() {
  ...
  fill(t = !0) {
    ...
    let n = !1;
    i && (e.save(), e.fillStyle = s.getPattern(e, this, yt(e), et.FILL), n = !0);
  ...
  endText() {
    ...
    for (const {
      ...
      s.addPath(l, new DOMMatrix(n).preMultiplySelf(i).translate(r, a).scale(o, -o));
  ...
  setFont(t, e) {
    ...
    if (i.fontMatrix = s.fontMatrix || Ce, (i.fontMatrix[0] === 0 || i.fontMatrix[3] === 0) && D("Invalid font matrix for font " + t), e < 0 ? (e = -e, i.fontDirection = -1) : i.fontDirection = 1, this.current.font = s, this.current.fontSize = e, s.isType3Font)
      return;
  ...
  setTextMatrix(t, e, s, i, n, r) {
    this.current.textMatrix = [t, e, s, i, n, r], this.current.textMatrixScale = Math.hypot(t, e), this.current.x = this.current.lineX = 0, this.current.y = this.current.lineY = 0;
  }
  nextLine() {
  ...
  paintChar(t, e, s, i, n) {
    ...
    if ((o.disableFontFace || u || f || p) && (g = o.getPathGenerator(this.commonObjs, t)), o.disableFontFace || f || p) {
      if (r.save(), r.translate(e, s), r.scale(h, -h), d === tt.FILL || d === tt.FILL_STROKE)
        if (i) {
          const b = r.getTransform();
          r.setTransform(...i), r.fill(this.#s(g, b, i));
        } else
          r.fill(g);
      if (d === tt.STROKE || d === tt.FILL_STROKE)
        if (n) {
          const b = r.getTransform();
          r.setTransform(...n), r.stroke(this.#s(g, b, n));
        } else
          r.lineWidth /= h, r.stroke(g);
      r.restore();
    } else
      (d === tt.FILL || d === tt.FILL_STROKE) && r.fillText(t, e, s), (d === tt.STROKE || d === tt.FILL_STROKE) && r.strokeText(t, e, s);
  ...
  showText(t) {
    ...
    if (e.patternFill) {
      n.save();
      const w = e.fillColor.getPattern(n, this, yt(n), et.FILL);
      m = U(n), n.restore(), n.fillStyle = w;
    }
    if (e.patternStroke) {
      n.save();
      const w = e.strokeColor.getPattern(n, this, yt(n), et.STROKE);
      A = U(n), n.restore(), n.strokeStyle = w;
    }
    let _ = e.lineWidth;
    const y = e.textMatrixScale;
    if (y === 0 || _ === 0) {
      const w = e.textRenderingMode & tt.FILL_STROKE_MASK;
      (w === tt.STROKE || w === tt.FILL_STROKE) && (_ = this.getSinglePixelWidth());
    } else
      _ /= y;
    if (r !== 1 && (n.scale(r, r), _ /= r), n.lineWidth = _, s.isInvalidPDFjsFont) {
      const w = [];
      let T = 0;
      for (const M of t)
        w.push(M.unicode), T += M.width;
      n.fillText(w.join(""), 0, 0), e.x += T * g * h, n.restore(), this.compose();
      return;
    }
    let v = 0, S;
    for (S = 0; S < d; ++S) {
      ...
      let T = !1;
      const M = (w.isSpace ? o : 0) + a, B = w.fontChar, N = w.accent;
      let G, q, $ = w.width;
      if (u) {
        const x = w.vmetric || p, P = -(w.vmetric ? x[1] : $ * 0.5) * g, dt = x[2] * g;
        $ = x ? -x[0] : $, G = P / r, q = (v + dt) / r;
      } else
        G = v / r, q = 0;
      if (s.remeasure && $ > 0) {
        ...
        if ($ < x && this.isFontSubpixelAAEnabled) {
          const P = $ / x;
          T = !0, n.save(), n.scale(P, 1), G /= P;
        } else $ !== x && (G += ($ - x) / 2e3 * i / r);
      }
      if (this.contentVisible && (w.isInFont || s.missingFile)) {
        if (b && !N)
          n.fillText(B, G, q);
      ...
      const it = u ? $ * g - M * l : $ * g + M * l;
      v += it, T && n.restore();
    }
    u ? e.y -= v : e.x += v * h, n.restore(), this.compose();
  }
  showType3Text(t) {
    ...
    if (!(f || n === 0)) {
      for (this._cachedScaleForStroking[0] = -1, this._cachedGetSinglePixelWidth = null, e.save(), e.transform(...s.textMatrix), e.translate(s.x, s.y), e.scale(h, r), p = 0; p < u; ++p) {
        ...
        const A = (g.isSpace ? l : 0) + o, _ = i.charProcOperatorList[g.operatorListId];
        if (!_) {
          D(`Type3 character "${g.operatorListId}" is not available.`);
          continue;
        }
        this.contentVisible && (this.processingType3 = g, this.save(), e.scale(n, n), e.transform(...d), this.executeOperatorList(_), this.restore()), b = C.applyTransform([g.width, 0], d)[0] * n + A, e.translate(b, 0), s.x += b * h;
      }
  ...
  getColorN_Pattern(t) {
    ...
    if (t[0] === "TilingPattern") {
      const s = t[1], i = this.baseTransform || U(this.ctx), n = {
        createCanvasGraphics: (r) => new Ht(r, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, {
  ...
  shadingFill(t) {
    ...
    e.fillStyle = s.getPattern(e, this, yt(e), et.SHADING);
    const i = yt(e);
    if (i) {
      const {
        width: n,
        height: r
      } = e.canvas, [a, o, l, h] = C.getAxialAlignedBoundingBox([0, 0, n, r], i);
  ...
  beginGroup(t) {
    ...
    }) : (e.setTransform(1, 0, 0, 1, 0, 0), e.translate(r, a), e.save()), Ut(e, u), this.ctx = u, this.setGState([["BM", "source-over"], ["ca", 1], ["CA", 1]]), this.groupStack.push(e), this.groupLevel++;
  }
  endGroup(t) {
    if (!this.contentVisible)
      return;
    ...
    if (this.ctx = s, this.ctx.imageSmoothingEnabled = !1, t.smask)
      ...
      const n = C.getAxialAlignedBoundingBox([0, 0, e.canvas.width, e.canvas.height], i);
      this.ctx.drawImage(e.canvas, 0, 0), this.ctx.restore(), this.compose(n);
    }
  }
  beginAnnotation(t, e, s, i, n) {
    if (this.#t(), ne(this.ctx), this.ctx.save(), this.save(), this.baseTransform && this.ctx.setTransform(...this.baseTransform), e) {
      const r = e[2] - e[0], a = e[3] - e[1];
      if (n && this.annotationCanvasMap) {
        s = s.slice(), s[4] -= e[0], s[5] -= e[1], e = e.slice(), e[0] = e[1] = 0, e[2] = r, e[3] = a;
        const [o, l] = C.singularValueDecompose2dScale(U(this.ctx)), {
          viewportScale: h
        } = this, d = Math.ceil(r * this.outputScaleX * h), u = Math.ceil(a * this.outputScaleY * h);
        ...
        ne(this.ctx), this.endPath(), this.ctx.rect(e[0], e[1], r, a), this.ctx.clip(), this.ctx.beginPath();
    }
  ...
  paintImageMaskXObjectRepeat(t, e, s = 0, i = 0, n, r) {
    ...
    for (let h = 0, d = r.length; h < d; h += 2) {
      const u = C.transform(o, [e, s, i, n, r[h], r[h + 1]]), [f, p] = C.applyTransform([0, 0], u);
  ...
  paintImageMaskXObjectGroup(t) {
    ...
    for (const n of t) {
      const {
        ...
        height: o,
        transform: l
      } = n, h = this.cachedCanvases.getCanvas("maskCanvas", a, o), d = h.context;
      d.save();
      const u = this.getObject(r, n);
      hs(d, u), d.globalCompositeOperation = "source-in", d.fillStyle = i ? s.getPattern(d, this, yt(e), et.FILL) : s, d.fillRect(0, 0, a, o), d.restore(), e.save(), e.transform(...l), e.scale(1, -1), ie(e, h.canvas, 0, 0, a, o, 0, -1, 1, 1), e.restore();
    }
    this.compose();
  }
  paintImageXObject(t) {
  ...
  paintImageXObjectRepeat(t, e, s, i) {
    ...
    for (let l = 0, h = i.length; l < h; l += 2)
      o.push({
  ...
  paintInlineImageXObject(t) {
    ...
    const r = this._scaleImage(n, yt(i));
  ...
  paintInlineImageXObjectGroup(t, e) {
    ...
    for (const n of e)
      s.save(), s.transform(...n.transform), s.scale(1, -1), ie(s, i, n.x, n.y, n.w, n.h, 0, -1, 1, 1), s.restore();
    this.compose();
  }
...
for (const c in bt)
  Ht.prototype[c] !== void 0 && (Ht.prototype[bt[c]] = Ht.prototype[c]);
class Kt {
  static #t = null;
  static #e = "";
...
class Oi {
  ...
  _setVisible(t, e, s = !1) {
    t !== Ot && H("Internal method `_setVisible` called."), this.#s = s, this.#i = e;
  }
}
class Bi {
  #t = null;
  ...
  constructor(t, e = ut.DISPLAY) {
    if (this.renderingIntent = e, this.name = null, this.creator = null, t !== null) {
      ...
      for (const s of t.groups)
        this.#e.set(s.id, new Oi(e, s));
      if (t.baseState === "OFF")
        for (const s of this.#e.values())
          s._setVisible(Ot, !1);
      for (const s of t.on)
        this.#e.get(s)._setVisible(Ot, !0);
      for (const s of t.off)
        this.#e.get(s)._setVisible(Ot, !1);
      this.#s = this.getHash();
    }
  }
  #r(t) {
    ...
    for (let i = 1; i < e; i++) {
      ...
      if (Array.isArray(n))
        ...
        return D(`Optional content group not found: ${n}`), !0;
      switch (s) {
        case "And":
          if (!r)
            return !1;
  ...
  isVisible(t) {
    if (this.#e.size === 0)
      return !0;
    if (!t)
      return de("Optional content group not defined."), !0;
    if (t.type === "OCG")
      return this.#e.has(t.id) ? this.#e.get(t.id).visible : (D(`Optional content group not found: ${t.id}`), !0);
    if (t.type === "OCMD") {
      if (t.expression)
      ...
      if (!t.policy || t.policy === "AnyOn") {
        for (const e of t.ids) {
          if (!this.#e.has(e))
            return D(`Optional content group not found: ${e}`), !0;
      ...
      return D(`Unknown optional content policy ${t.policy}.`), !0;
    }
    return D(`Unknown group type ${t.type}.`), !0;
  }
  setVisibility(t, e = !0, s = !0) {
    ...
    if (s && e && i.rbGroups.length)
      for (const n of i.rbGroups)
        for (const r of n)
          r !== t && this.#e.get(r)?._setVisible(Ot, !1, !0);
    i._setVisible(Ot, !!e, !0), this.#t = null;
  }
  setOCGState({
    state: t,
    preserveRB: e
  ...
  getGroups() {
    return this.#e.size > 0 ? De(this.#e) : null;
  }
  getGroup(t) {
...
class $i {
  constructor(t, e, s = !1, i = null) {
    this._stream = t, this._done = s || !1, this._filename = Oe(i) ? i : null, this._queuedChunks = e || [], this._loaded = 0;
...
function zi(c) {
  ...
  function l(h) {
    return !h.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(h) ? h : h.replaceAll(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, function(d, u, f, p) {
      if (f === "q" || f === "Q")
        return p = p.replaceAll("_", " "), p = p.replaceAll(/=([0-9a-fA-F]{2})/g, function(g, b) {
...
class Ui {
  constructor(t) {
    ...
    fetch(i, Is(s, this._withCredentials, this._abortController)).then((n) => {
      if (t._responseOrigin = me(n.url), !Ms(n.status))
        throw be(n.status, i);
      ...
      this._isRangeSupported = a, this._contentLength = o || this._contentLength, this._filename = Rs(r), !this._isStreamingSupported && this._isRangeSupported && this.cancel(new Pt("Streaming is disabled."));
...
class Wi {
  ...
  constructor({
    ...
    this.url = t, this.isHttp = /^https?:/i.test(t), this.headers = Ps(this.isHttp, e), this.withCredentials = s || !1, this.currXhrId = 0, this.pendingRequests = /* @__PURE__ */ Object.create(null);
  }
  request(t) {
...
class qi {
  ...
  _onHeadersReceived() {
    ...
    n && (this._isRangeSupported = !0), this._contentLength = r || this._contentLength, this._filename = Rs(i), this._isRangeSupported && this._manager.abortRequest(t), this._headersCapability.resolve();
  }
  _onDone(t) {
...
class Yi {
  ...
  _onHeadersReceived() {
    const t = me(this._manager.getRequestXhr(this._requestId)?.responseURL);
  ...
  _onError(t) {
    this._storedError ??= be(t, this._url);
    for (const e of this._requests)
      e.reject(this._storedError);
...
class rt {
  ...
  static #v = /* @__PURE__ */ new WeakMap();
  static #S = null;
  static #x = /* @__PURE__ */ new Set();
  constructor({
    textContentSource: t,
    container: e,
    viewport: s
    ...
    this.#b = [1, 0, 0, -1, -r, a + n], this.#o = i, this.#l = n, rt.#M(), It(e, s), this.#t.promise.finally(() => {
      rt.#x.delete(this), this.#n = null, this.#f = null;
    }).catch(() => {
    });
  }
  static get fontFamilyMap() {
    ...
    return F(this, "fontFamilyMap", /* @__PURE__ */ new Map([["sans-serif", `${t && e ? "Calibri, " : ""}sans-serif`], ["monospace", `${t && e ? "Lucida Console, " : ""}monospace`]]));
  }
  render() {
    const t = () => {
      this.#c.read().then(({
    ...
    return this.#c = this.#p.getReader(), rt.#x.add(this), t(), this.#t.promise;
  }
  update({
    viewport: t,
    onBefore: e = null
    ...
    if (i !== this.#u && (e?.(), this.#u = i, It(this.#h, {
      rotation: i
    })), s !== this.#d) {
      e?.(), this.#d = s;
      const n = {
      ...
      for (const r of this.#m)
        n.properties = this.#g.get(r), n.div = r, this.#w(n);
    }
  }
  cancel() {
  ...
  #T(t) {
    ...
    for (const i of t) {
      if (e.length > en) {
        D("Ignoring additional textDivs for performance reasons."), this.#s = !0;
        return;
      }
      if (i.str === void 0) {
  ...
  #k(t) {
    ...
    this.#m.push(e);
    const i = C.transform(this.#b, t.transform);
    ...
    const o = Math.hypot(i[2], i[3]), l = o * rt.#D(a, this.#r);
    let h, d;
    ...
    if (p && (s.canvasWidth = r.vertical ? t.height : t.width), this.#g.set(e, s), this.#n.div = e, this.#n.properties = s, this.#w(this.#n), s.hasText && this.#e.append(e), s.hasEOL) {
...
const nn = 65536, rn = 100, an = 5e3, on = st ? yi : bi, ln = st ? vi : Ss, hn = st ? _i : Ai, cn = st ? wi : Cs;
function dn(c = {}) {
  ...
  const t = new je(), {
    docId: e
  } = t, s = c.url ? un(c.url) : null, i = c.data ? fn(c.data) : null, n = c.httpHeaders || null, r = c.withCredentials === !0, a = c.password ?? null, o = c.range instanceof Ds ? c.range : null, l = Number.isInteger(c.rangeChunkSize) && c.rangeChunkSize > 0 ? c.rangeChunkSize : nn;
  let h = c.worker instanceof J ? c.worker : null;
  const d = c.verbosity, u = typeof c.docBaseUrl == "string" && !pe(c.docBaseUrl) ? c.docBaseUrl : null, f = typeof c.cMapUrl == "string" ? c.cMapUrl : null, p = c.cMapPacked !== !1, g = c.CMapReaderFactory || ln, b = typeof c.standardFontDataUrl == "string" ? c.standardFontDataUrl : null, m = c.StandardFontDataFactory || cn, A = c.stopAtErrors !== !0, _ = Number.isInteger(c.maxImageSize) && c.maxImageSize > -1 ? c.maxImageSize : -1, y = c.isEvalSupported !== !1, v = typeof c.isOffscreenCanvasSupported == "boolean" ? c.isOffscreenCanvasSupported : !st, S = typeof c.isImageDecoderSupported == "boolean" ? c.isImageDecoderSupported : !st && (at.platform.isFirefox || !globalThis.chrome), w = Number.isInteger(c.canvasMaxAreaInBytes) ? c.canvasMaxAreaInBytes : -1, T = typeof c.disableFontFace == "boolean" ? c.disableFontFace : st, M = c.fontExtraProperties === !0, B = c.enableXfa === !0, N = c.ownerDocument || globalThis.document, G = c.disableRange === !0, q = c.disableStream === !0, $ = c.disableAutoFetch === !0, it = c.pdfBug === !0, x = c.CanvasFactory || on, P = c.FilterFactory || hn, dt = c.enableHWA === !0, _t = o ? o.length : c.length ?? NaN, St = typeof c.useSystemFonts == "boolean" ? c.useSystemFonts : !st && !T, pt = typeof c.useWorkerFetch == "boolean" ? c.useWorkerFetch : g === Ss && m === Cs && f && b && Wt(f, document.baseURI) && Wt(b, document.baseURI), Z = null;
  Ys(d);
  const Y = {
    canvasFactory: new x({
      ownerDocument: N,
  ...
  return h.promise.then(function() {
    ...
    const ot = h.messageHandler.sendWithPromise("GetDocRequest", Ft, i ? [i.buffer] : null);
    let z;
    if (o)
      z = new Hi(o, {
        disableRange: G,
...
class je {
  static #t = 0;
  constructor() {
    this._capability = Promise.withResolvers(), this._transport = null, this._worker = null, this.docId = `d${je.#t++}`, this.destroyed = !1, this.onPassword = null, this.onProgress = null;
  }
  get promise() {
...
class gn {
  ...
  constructor(t, e, s, i = !1) {
    this._pageIndex = t, this._pageInfo = e, this._transport = s, this._stats = i ? new Ze() : null, this._pdfBug = i, this.commonObjs = s.commonObjs, this.objs = new Fs(), this._maybeCleanupAfterRender = !1, this._intentStates = /* @__PURE__ */ new Map(), this.destroyed = !1;
  }
  get pageNumber() {
  ...
  render({
    ...
    const u = this._transport.getRenderingIntent(s, i, h, d), {
      renderingIntent: f,
      cacheKey: p
    } = u;
    ...
    const m = (y) => {
      g.renderTasks.delete(A), (this._maybeCleanupAfterRender || b) && (this.#e = !0), this.#s(!b), y ? (A.capability.reject(y), this._abortOperatorList({
        intentState: g,
    ...
    (g.renderTasks ||= /* @__PURE__ */ new Set()).add(A);
    const _ = A.task;
    return Promise.all([g.displayReadyCapability.promise, a]).then(([y, v]) => {
      if (this.destroyed) {
        m();
        return;
      }
      if (this._stats?.time("Rendering"), !(v.renderingIntent & f))
  ...
  getTextContent(t = {}) {
    if (this._transport._htmlForXfa)
      return this.getXfa().then((s) => Jt.textContent(s));
  ...
  cleanup(t = !1) {
    this.#e = !0;
    const e = this.#s(!1);
    return t && e && (this._stats &&= new Ze()), e;
  }
  #s(t = !1) {
    if (this.#i(), !this.#e || this.destroyed)
      return !1;
    if (t)
...
class J {
  ...
  static #s;
  static {
    st && (this.#e = !0, Kt.workerSrc ||= "./pdf.worker.mjs"), this._isSameOrigin = (t, e) => {
      let s;
      try {
  ...
  constructor({
    ...
    if (this.name = t, this.destroyed = !1, this.verbosity = s, this._readyCapability = Promise.withResolvers(), this._port = null, this._webWorker = null, this._messageHandler = null, e) {
      ...
      (J.#s ||= /* @__PURE__ */ new WeakMap()).set(e, this), this._initializeFromPort(e);
      return;
    }
    this._initialize();
  }
  ...
  _initialize() {
    ...
    try {
      J._isSameOrigin(window.location.href, t) || (t = J._createCDNWrapper(new URL(t, window.location).href));
  ...
  _setupFakeWorker() {
    J.#e || (D("Setting up fake worker."), J.#e = !0), J._setupFakeWorkerGlobal.then((t) => {
      if (this.destroyed) {
      ...
      const e = new mn();
      this._port = e;
      const s = `fake${J.#t++}`, i = new Xt(s + "_worker", s, e);
      t.setup(i, e), this._messageHandler = new Xt(s, s + "_worker", e), this.#i();
    }).catch((t) => {
      this._readyCapability.reject(new Error(`Setting up fake worker failed: "${t.message}".`));
    });
  }
  destroy() {
    this.destroyed = !0, this._webWorker?.terminate(), this._webWorker = null, J.#s?.delete(this._port), this._port = null, this._messageHandler?.destroy(), this._messageHandler = null;
  }
  static fromPort(t) {
    if (!t?.port)
  ...
  static get _setupFakeWorkerGlobal() {
    return F(this, "_setupFakeWorkerGlobal", (async () => this.#r ? this.#r : (await import(
      /*webpackIgnore: true*/
      this.workerSrc
...
class bn {
  ...
  getRenderingIntent(t, e = Ct.ENABLE, s = null, i = !1, n = !1) {
    let r = ut.DISPLAY, a = ke;
    switch (t) {
      case "any":
        r = ut.ANY;
        break;
    ...
    const o = r & ut.PRINT && s instanceof ys ? s : this.annotationStorage;
    switch (e) {
      case Ct.DISABLE:
    ...
    t.on("GetReader", (s, i) => {
      X(this._networkStream, "GetReader - no `IPDFStream` instance available."), this._fullReader = this._networkStream.getFullReader(), this._fullReader.onProgress = (n) => {
        ...
        this._fullReader.read().then(function({
          ...
          X(n instanceof ArrayBuffer, "GetReader - expected an ArrayBuffer."), i.enqueue(new Uint8Array(n), 1, [n]);
        }).catch((n) => {
          i.error(n);
        });
      }, i.onCancel = (n) => {
      ...
      i.onPull = () => {
        n.read().then(function({
          ...
          X(r instanceof ArrayBuffer, "GetRangeReader - expected an ArrayBuffer."), i.enqueue(new Uint8Array(r), 1, [r]);
        }).catch((r) => {
          i.error(r);
        });
      }, i.onCancel = (r) => {
      ...
      switch (i) {
        case "Font":
          ...
          const l = o && globalThis.FontInspector?.enabled ? (u, f) => globalThis.FontInspector.fontAdded(u, f) : null, h = new mi(n, {
            disableFontFace: r,
            fontExtraProperties: a,
            inspectFont: l
          });
      ...
      if (!a.objs.has(s)) {
        ...
        switch (n) {
          case "Image":
            a.objs.resolve(s, r), r?.dataLen > Vs && (a._maybeCleanupAfterRender = !0);
            break;
          case "Pattern":
            a.objs.resolve(s, r);
            break;
  ...
  getOptionalContentConfig(t) {
    return this.#n("GetOptionalContentConfig").then((e) => new Bi(e, t));
  }
  getPermissions() {
...
class Fs {
  ...
  delete(t) {
    const e = this.#t[t];
    return !e || e.data === jt ? !1 : (delete this.#t[t], !0);
  }
  resolve(t, e = null) {
    const s = this.#e(t);
    s.data = e, s.resolve();
...
class Bt {
  ...
  constructor({
    ...
    this.callback = t, this.params = e, this.objs = s, this.commonObjs = i, this.annotationCanvasMap = n, this.operatorListIdx = null, this.operatorList = r, this._pageIndex = a, this.canvasFactory = o, this.filterFactory = l, this._pdfBug = d, this.pageColors = u, this.running = !1, this.graphicsReadyCallback = null, this.graphicsReady = !1, this._useRequestAnimationFrame = h === !0 && typeof window < "u", this.cancelled = !1, this.capability = Promise.withResolvers(), this.task = new An(this), this._cancelBound = this.cancel.bind(this), this._continueBound = this._continue.bind(this), this._scheduleNextBound = this._scheduleNext.bind(this), this._nextBound = this._next.bind(this), this._canvas = e.canvasContext.canvas;
  }
  get completed() {
  ...
  initializeGraphics({
    ...
    if (this.cancelled)
      return;
    if (this._canvas) {
      if (Bt.#e.has(this._canvas))
        throw new Error("Cannot use the same canvas during multiple render() operations. Use different canvas or ensure previous operations were cancelled or completed.");
      Bt.#e.add(this._canvas);
    }
  ...
  cancel(t = null, e = 0) {
    this.running = !1, this.cancelled = !0, this.gfx?.endDrawing(), this.#t && (window.cancelAnimationFrame(this.#t), this.#t = null), Bt.#e.delete(this._canvas), this.callback(t || new Ne(`Rendering cancelled, page ${this._pageIndex + 1}`, e));
  }
  operatorListChanged() {
  ...
  async _next() {
    this.cancelled || (this.operatorListIdx = this.gfx.executeOperatorList(this.operatorList, this.operatorListIdx, this._continueBound, this.stepper), this.operatorListIdx === this.operatorList.argsArray.length && (this.running = !1, this.operatorList.lastChunk && (this.gfx.endDrawing(), Bt.#e.delete(this._canvas), this.callback())));
  }
}
const _n = "4.10.38", yn = "f9bea397f";
function ps(c) {
...
class gs {
  ...
  static CMYK_rgb([t, e, s, i]) {
    return [Vt(1 - Math.min(1, t + i)), Vt(1 - Math.min(1, s + i)), Vt(1 - Math.min(1, e + i))];
  }
  static CMYK_HTML(t) {
...
const ee = 1e3, wn = 9, Lt = /* @__PURE__ */ new WeakSet();
function Tt(c) {
  return {
    width: c[2] - c[0],
    height: c[3] - c[1]
...
class V {
  ...
  get hasPopupData() {
    return V._hasPopupData(this.data);
  }
  updateEdited(t) {
    if (!this.container)
      return;
  ...
  _createContainer(t) {
    ...
    if (r.zIndex = this.parent.zIndex++, e.alternativeText && (n.title = e.alternativeText), e.noRotate && n.classList.add("norotate"), !e.rect || this instanceof Me) {
      const {
        rotation: g
      } = e;
    ...
    if (!t && e.borderStyle.width > 0) {
      ...
      m ? (this.#e = !0, r.borderColor = C.makeHexColor(m[0] | 0, m[1] | 0, m[2] | 0)) : r.borderWidth = 0;
    }
  ...
  _createQuadrilaterals() {
    ...
    if (this.#e) {
      ...
      r.borderWidth = 0, a = ["url('data:image/svg+xml;utf8,", '<svg xmlns="http://www.w3.org/2000/svg"', ' preserveAspectRatio="none" viewBox="0 0 1 1">', `<g fill="transparent" stroke="${g}" stroke-width="${b}">`], this.container.classList.add("hasBorder");
    }
    const o = i - e, l = n - s, {
      svgFactory: h
    } = this, d = h.createElement("svg");
    ...
    for (let g = 2, b = t.length; g < b; g += 8) {
      const m = t[g], A = t[g + 1], _ = t[g + 2], y = t[g + 3], v = h.createElement("rect"), S = (_ - e) / o, w = (n - A) / l, T = (m - _) / o, M = (A - y) / l;
      v.setAttribute("x", S), v.setAttribute("y", w), v.setAttribute("width", T), v.setAttribute("height", M), f.append(v), a?.push(`<rect vector-effect="non-scaling-stroke" x="${S}" y="${w}" width="${T}" height="${M}"/>`);
    }
...
class Os extends V {
  ...
  _bindResetFormAction(t, e) {
    ...
    if (s || (t.href = this.linkService.getAnchorUrl("")), this.#t(), !this._fieldObjects) {
      D('_bindResetFormAction - "resetForm" action not supported, ensure that the `fieldObjects` parameter is provided.'), s || (t.onclick = () => !1);
      return;
    }
    t.onclick = () => {
      s?.();
...
class Dt extends V {
  ...
  _setTextStyle(t) {
    const e = ["left", "center", "right"], {
      fontColor: s
    } = this.data.defaultAppearanceData, i = this.data.defaultAppearanceData.fontSize || wn, n = t.style;
    let r;
    const a = 2, o = (l) => Math.round(10 * l) / 10;
    if (this.data.multiLine) {
      const l = Math.abs(this.data.rect[3] - this.data.rect[1] - a), h = Math.round(l / (_e * i)) || 1, d = l / h;
      r = Math.min(i, o(d / _e));
    } else {
...
`) || null;
      ...
      this.data.multiLine ? (s = document.createElement("textarea"), s.textContent = a ?? n, this.data.doNotScroll && (s.style.overflowY = "hidden")) : (s = document.createElement("input"), s.type = "text", s.setAttribute("value", a ?? n), this.data.doNotScroll && (s.style.overflowX = "hidden")), this.data.hasOwnCanvas && (s.hidden = !0), Lt.add(s), s.setAttribute("data-element-id", e), s.disabled = this.data.readOnly, s.name = this.data.fieldName, s.tabIndex = ee, this._setRequired(s, this.data.required), r && (s.maxLength = r), s.addEventListener("input", (h) => {
        t.setValue(e, {
      ...
      if (this.enableScripting && this.hasJSActions) {
        s.addEventListener("focus", (d) => {
          ...
          o.commitKey = 1;
          let u = -1;
          if (d.key === "Escape" ? u = 0 : d.key === "Enter" && !this.data.multiLine ? u = 2 : d.key === "Tab" && (o.commitKey = 3), u === -1)
            return;
          const {
            value: f
          } = d.target;
        ...
        l = null, s.addEventListener("blur", (d) => {
          ...
          switch (d.inputType) {
            case "deleteWordBackward": {
              const _ = p.substring(0, g).match(/\w*[^\w]*$/);
              _ && (m -= _[0].length);
              break;
            }
            case "deleteWordForward": {
              const _ = p.substring(g).match(/^[^\w]*\w*/);
              _ && (A += _[0].length);
              break;
            }
        ...
        }), this._setEventListeners(s, o, [["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (d) => d.target.value);
      }
...
class Tn extends Dt {
  ...
  render() {
    ...
    return Lt.add(n), n.setAttribute("data-element-id", s), n.disabled = e.readOnly, this._setRequired(n, this.data.required), n.type = "checkbox", n.name = e.fieldName, i && n.setAttribute("checked", !0), n.setAttribute("exportValue", e.exportValue), n.tabIndex = ee, n.addEventListener("change", (r) => {
      const {
        name: a,
        checked: o
      } = r.target;
...
class Bs extends Dt {
  ...
  render() {
    ...
    const n = document.createElement("input");
    if (Lt.add(n), n.setAttribute("data-element-id", s), n.disabled = e.readOnly, this._setRequired(n, this.data.required), n.type = "radio", n.name = e.fieldName, i && n.setAttribute("checked", !0), n.tabIndex = ee, n.addEventListener("change", (r) => {
      const {
        name: a,
        checked: o
      } = r.target;
  ...
  render() {
    ...
    return this.enableScripting && this.hasJSActions ? (i.addEventListener("updatefromsandbox", (h) => {
      const d = {
        value(u) {
          r?.();
          const f = u.detail.value, p = new Set(Array.isArray(f) ? f : [f]);
          for (const g of i.options)
            g.selected = p.has(g.value);
          t.setValue(e, {
            value: a(!0)
          }), o = a(!1);
        },
        ...
        items(u) {
          ...
          for (const p of f) {
            const {
              displayValue: g,
              exportValue: b
            } = p, m = document.createElement("option");
        ...
        indices(u) {
          ...
          for (const p of u.target.options)
            p.selected = f.has(p.index);
          t.setValue(e, {
            value: a(!0)
          }), o = a(!1);
        },
...
class Rn {
  ...
  constructor({
    ...
    this.#n = t, this.#g = i, this.#l = r, this.#m = a, this.#h = o, this.#r = e, this.#p = l, this.#u = h, this.#c = s, this.#o = As.toDateObject(n), this.trigger = s.flatMap((u) => u.getElementsToTriggerPopup());
    for (const u of this.trigger)
      u.addEventListener("click", this.#i), u.addEventListener("mouseenter", this.#s), u.addEventListener("mouseleave", this.#e), u.classList.add("popupTriggerArea");
    for (const u of s)
      u.container?.addEventListener("keydown", this.#t);
    this.#n.hidden = !0, d && this.#w();
  }
  render() {
    if (this.#f)
      return;
    ...
    if (t.className = "popup", this.#r) {
      const n = t.style.outlineColor = C.makeHexColor(...this.#r);
      CSS.supports("background-color", "color-mix(in srgb, red 30%, white)") ? t.style.backgroundColor = `color-mix(in srgb, ${n} 30%, white)` : t.style.backgroundColor = C.makeHexColor(...this.#r.map((a) => Math.floor(0.7 * (255 - a) + a)));
    }
    const e = document.createElement("span");
    e.className = "header";
  ...
  #x(t) {
    const e = [], s = {
      ...
      style: {
        color: this.#S,
        fontSize: this.#v ? `calc(${this.#v}px * var(--scale-factor))` : ""
      }
    };
...
`))
  ...
  #T(t) {
    t.altKey || t.shiftKey || t.ctrlKey || t.metaKey || (t.key === "Enter" || t.key === "Escape" && this.#d) && this.#w();
  }
  updateEdited({
    rect: t,
    popupContent: e
  ...
  resetEdited() {
    this.#b && ({
      contentsObj: this.#l,
      richText: this.#m
    } = this.#b, this.#b = null, this.#f?.remove(), this.#f = null, this.#a = null);
  }
  #k() {
    if (this.#a !== null)
      return;
    ...
    const o = C.normalizeRect([a[0], t[3] - a[1] + t[1], a[2], t[3] - a[3] + t[1]]), h = r ? a[2] - a[0] + 5 : 0, d = o[0] + h, u = o[1];
    this.#a = [100 * (d - i) / e, 100 * (u - n) / s];
    const {
      style: f
    } = this.#n;
  ...
  #P() {
    this.#f || this.render(), this.isVisible ? this.#d && this.#n.classList.add("focused") : (this.#k(), this.#n.hidden = !1, this.#n.style.zIndex = parseInt(this.#n.style.zIndex) + 1e3);
  }
  #C() {
  ...
  forceHide() {
    this.#y = this.isVisible, this.#y && (this.#n.hidden = !0);
  }
  maybeShow() {
    this.#y && (this.#f || this.#P(), this.#y = !1, this.#n.hidden = !1);
  }
  get isVisible() {
...
class Mn extends V {
  ...
  render() {
    ...
    const t = this.data, {
      width: e,
      height: s
    } = Tt(t.rect), i = this.svgFactory.create(e, s, !0), n = this.#t = this.svgFactory.createElement("svg:line");
...
class In extends V {
  ...
  render() {
    ...
    const t = this.data, {
      width: e,
      height: s
    } = Tt(t.rect), i = this.svgFactory.create(e, s, !0), n = t.borderStyle.width, r = this.#t = this.svgFactory.createElement("svg:rect");
...
class Ln extends V {
  ...
  render() {
    ...
    const t = this.data, {
      width: e,
      height: s
    } = Tt(t.rect), i = this.svgFactory.create(e, s, !0), n = t.borderStyle.width, r = this.#t = this.svgFactory.createElement("svg:ellipse");
...
class $s extends V {
  ...
  render() {
    ...
    const {
      width: n,
      height: r
    } = Tt(t), a = this.svgFactory.create(n, r, !0);
    let o = [];
...
class $n {
  ...
  async #r(t, e) {
    const s = t.firstChild || t, i = s.id = `${Fe}${e}`, n = await this.#i?.getAriaAttributes(i);
    if (n)
      for (const [r, a] of n)
        s.setAttribute(r, a);
...
class Q extends R {
  ...
  static get _keyboardManager() {
    const t = Q.prototype, e = (n) => n.isEmpty(), s = kt.TRANSLATE_SMALL, i = kt.TRANSLATE_BIG;
    return F(this, "_keyboardManager", new te([[["ctrl+s", "mac+meta+s", "ctrl+p", "mac+meta+p"], t.commitOrRemove, {
      bubbles: !0
  ...
  constructor(t) {
    super({
      ...t,
      name: "freeTextEditor"
    }), this.#t = t.color || Q._defaultColor || R._defaultLineColor, this.#r = t.fontSize || Q._defaultFontSize;
  }
  static initialize(t, e) {
    R.initialize(t, e);
    const s = getComputedStyle(document.documentElement);
  ...
  static get defaultPropertiesToUpdate() {
    return [[O.FREETEXT_SIZE, Q._defaultFontSize], [O.FREETEXT_COLOR, Q._defaultColor || R._defaultLineColor]];
  }
  get propertiesToUpdate() {
    return [[O.FREETEXT_SIZE, this.#r], [O.FREETEXT_COLOR, this.#t]];
  }
  #n(t) {
    const e = (i) => {
  ...
  getInitialTranslation() {
    ...
    return [-Q._internalPadding * t, -(Q._internalPadding + this.#r) * t];
  }
  rebuild() {
  ...
  enableEditMode() {
    if (this.isInEditMode())
      return;
    this.parent.setEditingState(!1), this.parent.updateToolbar(L.FREETEXT), super.enableEditMode(), this.overlayDiv.classList.remove("enabled"), this.editorDiv.contentEditable = !0, this._isDraggable = !1, this.div.removeAttribute("aria-activedescendant"), this.#i = new AbortController();
  ...
  #o() {
    ...
    for (const s of this.editorDiv.childNodes)
      e?.nodeType === Node.TEXT_NODE && s.nodeName === "BR" || (t.push(Q.#h(s)), e = s);
    return t.join(`
`);
  }
  #c() {
  ...
  render() {
    ...
    if (s.fontSize = `calc(${this.#r}px * var(--scale-factor))`, s.color = this.#t, this.div.append(this.editorDiv), this.overlayDiv = document.createElement("div"), this.overlayDiv.classList.add("overlay", "enabled"), this.div.append(this.overlayDiv), le(this, this.div, ["dblclick", "keydown"]), this.width) {
      ...
      if (this.annotationElementId) {
        ...
        switch (this.rotation) {
          case 0:
            ...
            break;
          case 90:
            f = t + (r[0] - d) / l, p = e - (r[1] - u) / h, [a, o] = [o, -a];
            break;
          case 180:
            f = t - this.width + (r[0] - d) / l, p = e - (r[1] - u) / h, [a, o] = [-a, -o];
            break;
          case 270:
            f = t + (r[0] - d - this.height * h) / l, p = e + (r[1] - u - this.width * l) / h, [a, o] = [-o, a];
            break;
        }
  ...
  editorDivPaste(t) {
    ...
    if (s.length === 1 && s[0] === "text/plain")
      return;
    t.preventDefault();
    const i = Q.#f(e.getData("text") || "").replaceAll(re, `
`);
    if (!i)
      return;
...
`),
    ...
    return n.#r = t.fontSize, n.#t = C.makeHexColor(...t.color), n.#e = Q.#f(t.value), n.annotationElementId = t.id || null, n._initialData = i, n;
  }
  serialize(t = !1) {
    if (this.isEmpty())
      return null;
    if (this.deleted)
      return this.serializeDeleted();
    const e = Q._internalPadding * this.parentScale, s = this.getRect(e, e), i = R._colorManager.convert(this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#t), n = {
      annotationType: L.FREETEXT,
      color: i,
      fontSize: this.#r,
      value: this.#d(),
...
class Mt {
  ...
  constructor({
    ...
    this.#t = s, this.#d = n * i, this.#i = r, this.#n.set([NaN, NaN, NaN, NaN, t, e], 6), this.#s = a, this.#h = Mt.#a * i, this.#c = Mt.#m * i, this.#u = i, this.#f.push(t, e);
  }
  isEmpty() {
  ...
  #g() {
    ...
    return [(this.#l + (t[0] - e[0]) / 2 - s) / n, (this.#o + (t[1] - e[1]) / 2 - i) / r, (this.#l + (e[0] - t[0]) / 2 - s) / n, (this.#o + (e[1] - t[1]) / 2 - i) / r];
  }
  add({
    x: t,
    y: e
    ...
    const y = -m / p, v = b / p, S = y * this.#d, w = v * this.#d;
    return this.#n.set(this.#n.subarray(2, 8), 0), this.#n.set([l + S, h + w], 4), this.#n.set(this.#n.subarray(14, 18), 12), this.#n.set([l - S, h - w], 16), isNaN(this.#n[6]) ? (this.#r.length === 0 && (this.#n.set([a + S, o + w], 2), this.#r.push(NaN, NaN, NaN, NaN, (a + S - s) / n, (o + w - i) / r), this.#n.set([a - S, o - w], 14), this.#e.push(NaN, NaN, NaN, NaN, (a - S - s) / n, (o - w - i) / r)), this.#n.set([A, _, a, o, l, h], 6), !this.isEmpty()) : (this.#n.set([A, _, a, o, l, h], 6), Math.abs(Math.atan2(_ - o, A - a) - Math.atan2(m, b)) < Math.PI / 2 ? ([a, o, l, h] = this.#n.subarray(2, 6), this.#r.push(NaN, NaN, NaN, NaN, ((a + l) / 2 - s) / n, ((o + h) / 2 - i) / r), [a, o, A, _] = this.#n.subarray(14, 18), this.#e.push(NaN, NaN, NaN, NaN, ((A + a) / 2 - s) / n, ((_ + o) / 2 - i) / r), !0) : ([A, _, a, o, l, h] = this.#n.subarray(0, 6), this.#r.push(((A + 5 * a) / 6 - s) / n, ((_ + 5 * o) / 6 - i) / r, ((5 * a + l) / 6 - s) / n, ((5 * o + h) / 6 - i) / r, ((a + l) / 2 - s) / n, ((o + h) / 2 - i) / r), [l, h, a, o, A, _] = this.#n.subarray(12, 18), this.#e.push(((A + 5 * a) / 6 - s) / n, ((_ + 5 * o) / 6 - i) / r, ((5 * a + l) / 6 - s) / n, ((5 * o + h) / 6 - i) / r, ((a + l) / 2 - s) / n, ((o + h) / 2 - i) / r), !0));
  }
  toSVGPath() {
    if (this.isEmpty())
      return "";
  ...
  getOutlines() {
    ...
    if (o[o.length - 2] = (this.#l - i) / r, o[o.length - 1] = (this.#o - n) / a, isNaN(s[6]) && !this.isEmpty())
      return this.#v(o);
  ...
  #v(t) {
    ...
    return d.set([NaN, NaN, NaN, NaN, (e[2] - s) / n, (e[3] - i) / r, NaN, NaN, NaN, NaN, (e[4] - s) / n, (e[5] - i) / r, NaN, NaN, NaN, NaN, a, o, NaN, NaN, NaN, NaN, l, h, NaN, NaN, NaN, NaN, (e[16] - s) / n, (e[17] - i) / r, NaN, NaN, NaN, NaN, (e[14] - s) / n, (e[15] - i) / r], 0), this.newFreeDrawOutline(d, t, this.#t, this.#u, this.#s, this.#i);
  }
  #S(t, e) {
    const s = this.#e;
...
class Us extends E {
  ...
  constructor(t, e, s, i, n, r) {
    super(), this.#l = t, this.#r = e, this.#t = s, this.#n = i, this.#s = n, this.#i = r, this.lastPoint = [NaN, NaN], this.#o(r);
    const [a, o, l, h] = this.#e;
    for (let d = 0, u = t.length; d < u; d += 2)
      t[d] = (t[d] - a) / l, t[d + 1] = (t[d + 1] - o) / h;
    for (let d = 0, u = e.length; d < u; d += 2)
      e[d] = (e[d] - a) / l, e[d + 1] = (e[d + 1] - o) / h;
  }
  toSVGPath() {
    const t = [`M${this.#l[4]} ${this.#l[5]}`];
  ...
  serialize([t, e, s, i], n) {
    ...
    switch (n) {
      case 0:
        o = E._rescale(this.#l, t, i, r, -a), l = E._rescale(this.#r, t, i, r, -a);
        break;
      case 90:
        o = E._rescaleAndSwap(this.#l, t, e, r, a), l = E._rescaleAndSwap(this.#r, t, e, r, a);
        break;
      case 180:
        o = E._rescale(this.#l, s, e, -r, a), l = E._rescale(this.#r, s, e, -r, a);
        break;
      case 270:
        o = E._rescaleAndSwap(this.#l, s, i, -r, -a), l = E._rescaleAndSwap(this.#r, s, i, -r, -a);
        break;
    }
    return {
  ...
  #o(t) {
    ...
    for (let f = 6, p = e.length; f < p; f += 6) {
      if (isNaN(e[f]))
        n = Math.min(n, e[f + 4]), r = Math.min(r, e[f + 5]), a = Math.max(a, e[f + 4]), o = Math.max(o, e[f + 5]), h < e[f + 5] ? (l = e[f + 4], h = e[f + 5]) : h === e[f + 5] && (l = d(l, e[f + 4]));
      else {
    ...
    const u = this.#e;
    u[0] = n - this.#s, u[1] = r - this.#s, u[2] = a - n + 2 * this.#s, u[3] = o - r + 2 * this.#s, this.lastPoint = [l, h];
  }
  get box() {
    return this.#e;
  }
  newOutliner(t, e, s, i, n, r = 0) {
    return new Mt(t, e, s, i, n, r);
  }
  getNewOutline(t, e) {
...
class Ie {
  ...
  constructor(t, e = 0, s = 0, i = !0) {
    ...
    for (const {
      ...
      const y = Math.floor((b - e) / l) * l, v = Math.ceil((b + A + e) / l) * l, S = Math.floor((m - e) / l) * l, w = Math.ceil((m + _ + e) / l) * l, T = [y, S, w, !0], M = [v, S, w, !1];
      this.#s.push(T, M), n = Math.min(n, y), r = Math.max(r, v), a = Math.min(a, S), o = Math.max(o, w);
    }
    const h = r - n + 2 * s, d = o - a + 2 * s, u = n - s, f = a - s, p = this.#s.at(i ? -1 : -2), g = [p[0], p[2]];
    for (const b of this.#s) {
      const [m, A, _] = b;
      b[0] = (m - u) / h, b[1] = (A - f) / d, b[2] = (_ - f) / d;
    }
    this.#t = new Float32Array([u, f, h, d]), this.#e = g;
  }
  getOutlines() {
    this.#s.sort((e, s) => e[0] - s[0] || e[1] - s[1] || e[2] - s[2]);
    const t = [];
    for (const e of this.#s)
      e[3] ? (t.push(...this.#c(e)), this.#l(e)) : (this.#o(e), t.push(...this.#c(e)));
    return this.#r(t);
  }
  #r(t) {
...
class mt {
  ...
  static #d = null;
  static get _keyboardManager() {
    return F(this, "_keyboardManager", new te([[["Escape", "mac+Escape"], mt.prototype._hideDropdownFromKeyboard], [[" ", "mac+ "], mt.prototype._colorSelectFromKeyboard], [["ArrowDown", "ArrowRight", "mac+ArrowDown", "mac+ArrowRight"], mt.prototype._moveToNext], [["ArrowUp", "ArrowLeft", "mac+ArrowUp", "mac+ArrowLeft"], mt.prototype._moveToPrevious], [["Home", "mac+Home"], mt.prototype._moveToBeginning], [["End", "mac+End"], mt.prototype._moveToEnd]]));
  }
  constructor({
    editor: t = null,
    uiManager: e = null
  }) {
    t ? (this.#n = !1, this.#u = O.HIGHLIGHT_COLOR, this.#l = t) : (this.#n = !0, this.#u = O.HIGHLIGHT_DEFAULT_COLOR), this.#h = t?._uiManager || e, this.#o = this.#h._eventBus, this.#s = t?.color || this.#h?.highlightColors.values().next().value || "#FFFF98", mt.#d ||= Object.freeze({
  ...
  #f() {
    ...
    for (const [s, i] of this.#h.highlightColors) {
      ...
      n.tabIndex = "0", n.role = "option", n.setAttribute("data-color", i), n.title = s, n.setAttribute("data-l10n-id", mt.#d[s]);
...
class j extends R {
  ...
  static get _keyboardManager() {
    const t = j.prototype;
    return F(this, "_keyboardManager", new te([[["ArrowLeft", "mac+ArrowLeft"], t._moveCaret, {
      args: [0]
  ...
  constructor(t) {
    ...
    }), this.color = t.color || j._defaultColor, this.#g = t.thickness || j._defaultThickness, this.#a = t.opacity || j._defaultOpacity, this.#s = t.boxes || null, this.#b = t.methodOfCreation || "", this.#m = t.text || "", this._isDraggable = !1, t.highlightId > -1 ? (this.#d = !0, this.#A(t), this.#k()) : this.#s && (this.#t = t.anchorNode, this.#e = t.anchorOffset, this.#l = t.focusNode, this.#o = t.focusOffset, this.#y(), this.#k(), this.rotate(this.rotation));
  }
  get telemetryInitialData() {
    return {
      action: "added",
  ...
  #y() {
    const t = new Ie(this.#s, 1e-3);
    this.#h = t.getOutlines(), [this.x, this.y, this.width, this.height] = this.#h.box;
    const e = new Ie(this.#s, 25e-4, 1e-3, this._uiManager.direction === "ltr");
  ...
  #A({
    ...
    if (this.#n = t.getNewOutline(this.#g / 2 + i, 25e-4), e >= 0)
      ...
      this.parent.drawLayer.updateProperties(this.#u, {
        bbox: j.#w(this.#h.box, (h - this.rotation + 360) % 360),
        path: {
          d: t.toSVGPath()
        }
      }), this.parent.drawLayer.updateProperties(this.#p, {
        bbox: j.#w(this.#n.box, h),
        path: {
          d: this.#n.toSVGPath()
        }
      });
  ...
  static initialize(t, e) {
    R.initialize(t, e), j._defaultColor ||= e.highlightColors?.values().next().value || "#fff066";
  }
  static updateDefaultParams(t, e) {
    switch (t) {
      case O.HIGHLIGHT_DEFAULT_COLOR:
  ...
  static get defaultPropertiesToUpdate() {
    return [[O.HIGHLIGHT_DEFAULT_COLOR, j._defaultColor], [O.HIGHLIGHT_THICKNESS, j._defaultThickness]];
  }
  get propertiesToUpdate() {
  ...
  #v(t) {
    ...
    this.addCommands({
      cmd: e.bind(this, t, j._defaultOpacity),
  ...
  async addEditToolbar() {
    ...
    return t ? (this._uiManager.highlightColors && (this.#r = new mt({
      editor: this
  ...
  rebuild() {
    this.parent && (super.rebuild(), this.div !== null && (this.#k(), this.isAttachedToDOM || this.parent.add(this)));
  }
  setParent(t) {
    let e = !1;
    this.parent && !t ? this.#T() : t && (this.#k(t), e = !this.parent && this.div?.classList.contains("selectedEditor")), super.setParent(t), this.show(this._isVisible), e && this.select();
  }
  #x(t) {
    if (!this.#d)
      return;
  ...
  rotate(t) {
    ...
    let s;
    this.#d ? (t = (t - this.rotation + 360) % 360, s = j.#w(this.#h.box, t)) : s = j.#w([this.x, this.y, this.width, this.height], t), e.updateProperties(this.#u, {
      bbox: s,
      root: {
        "data-main-rotation": t
      }
    }), e.updateProperties(this.#p, {
      bbox: j.#w(this.#n.box, t),
      root: {
        "data-main-rotation": t
      }
    });
  ...
  render() {
    ...
    const [s, i] = this.parentDimensions;
    return this.setDims(this.width * s, this.height * i), le(this, this.#c, ["pointerover", "pointerleave"]), this.enableEditing(), t;
  }
  pointerover() {
  ...
  #P(t) {
    j._keyboardManager.exec(this, t);
  }
  _moveCaret(t) {
  ...
  static async deserialize(t, e, s) {
    ...
    l.color = C.makeHexColor(...n), l.#a = o || 1, a && (l.#g = t.thickness), l.annotationElementId = t.id || null, l._initialData = i;
    const [h, d] = l.pageDimensions, [u, f] = l.pageTranslation;
    if (r) {
      const p = l.#s = [];
      for (let g = 0; g < r.length; g += 8)
        p.push({
          x: (r[g] - u) / h,
          y: 1 - (r[g + 1] - f) / d,
          width: (r[g + 2] - r[g]) / h,
      ...
      l.#y(), l.#k(), l.rotate(l.rotation);
    } else if (a) {
      l.#d = !0;
      const p = a[0], g = {
        x: p[0] - u,
        y: d - (p[1] - f)
      }, b = new Le(g, [0, 0, h, d], 1, l.#g / 2, !0, 1e-3);
      for (let _ = 0, y = p.length; _ < y; _ += 2)
        g.x = p[_] - u, g.y = d - (p[_ + 1] - f), b.add(g);
      const {
        id: m,
        clipPathId: A
      } = e.drawLayer.draw({
  ...
  serialize(t = !1) {
    ...
    if (this.deleted)
      return this.serializeDeleted();
    const e = this.getRect(0, 0), s = R._colorManager.convert(this.color), i = {
      annotationType: L.HIGHLIGHT,
      color: s,
      opacity: this.#a,
      thickness: this.#g,
...
class k extends R {
  ...
  #u(t, e) {
    const {
      id: s
    } = e.drawLayer.draw(k._mergeSVGProperties(this._drawingOptions.toSVGProperties(), t.defaultSVGProperties), !1, !1);
    return s;
  }
  ...
  static startDrawing(t, e, s, i) {
    ...
    const {
      ...
      width: d,
      height: u
    } = n.getBoundingClientRect(), f = k.#i = new AbortController(), p = t.combinedSignal(f);
    if (k.#n ||= o, k.#l ??= l, window.addEventListener("pointerup", (g) => {
      ...
      k.#l === g.pointerType && ((k.#o ||= /* @__PURE__ */ new Set()).add(g.pointerId), k.#s.isCancellable() && (k.#s.removeLastElement(), k.#s.isEmpty() ? this._currentParent.endDrawingSession(!0) : this._endDraw(null)));
    }, {
      capture: !0,
      passive: !1,
      signal: p
    ...
    e.updateUIForDefaultProperties(this), k.#s = this.createDrawerInstance(r, a, d, u, h), k.#r = this.getDefaultDrawingOptions(), this._currentParent = t, {
      id: this._currentDrawId
    } = t.drawLayer.draw(this._mergeSVGProperties(k.#r.toSVGProperties(), k.#s.defaultSVGProperties), !0, !1);
  }
  static _drawMove(t) {
    if (k.#c = -1, !k.#s)
      return;
    ...
    if (k.#n === i) {
      ...
      this._currentParent.drawLayer.updateProperties(this._currentDrawId, k.#s.add(e, s)), k.#c = t.timeStamp, ft(t);
    }
  }
  static _cleanup(t) {
  ...
  static endDrawing(t) {
    ...
    if (!e)
      return null;
    if (e.toggleDrawing(!0), e.cleanUndoStack(O.DRAW_STEP), !k.#s.isEmpty()) {
      const {
        pageDimensions: [s, i],
        scale: n
...
class jn {
  ...
  #d(t, e) {
    return E._normalizePoint(t, e, this.#h, this.#u, this.#i);
  }
  isEmpty() {
  ...
  add(t, e) {
    ...
    return Math.hypot(this.#h * a, this.#u * o) <= 2 ? null : (this.#n.push(t, e), isNaN(s) ? (this.#t.set([n, r, t, e], 2), this.#e.push(NaN, NaN, NaN, NaN, t, e), {
      path: {
        d: this.toSVGPath()
      }
    }) : (isNaN(this.#t[0]) && this.#e.splice(6, 6), this.#t.set([s, i, n, r, t, e], 0), this.#e.push(...E.createBezierPoints(s, i, n, r, t, e)), {
      path: {
        d: this.toSVGPath()
      }
    }));
  ...
  toSVGPath() {
    const t = E.svgRound(this.#e[4]), e = E.svgRound(this.#e[5]);
    if (this.#n.length === 2)
      return this.#l = `${this.#l} M ${t} ${e} Z`, this.#l;
    if (this.#n.length <= 6) {
      const i = this.#l.lastIndexOf("M");
      this.#l = `${this.#l.slice(0, i)} M ${t} ${e}`, this.#o = 6;
    }
    if (this.#n.length === 4) {
      const i = E.svgRound(this.#e[10]), n = E.svgRound(this.#e[11]);
      return this.#l = `${this.#l} L ${i} ${n}`, this.#o = 12, this.#l;
    }
    const s = [];
    this.#o === 0 && (s.push(`M ${t} ${e}`), this.#o = 6);
    for (let i = this.#o, n = this.#e.length; i < n; i += 6) {
      const [r, a, o, l, h, d] = this.#e.slice(i, i + 6).map(E.svgRound);
...
class Ae extends E {
  ...
  serialize([t, e, s, i], n) {
    ...
    let u, f, p, g, b, m, A, _, y;
    switch (this.#o) {
      case 0:
        y = E._rescale, u = t, f = e + i, p = s, g = -i, b = t + o * s, m = e + (1 - l - d) * i, A = t + (o + h) * s, _ = e + (1 - l) * i;
        break;
      case 90:
        y = E._rescaleAndSwap, u = t, f = e, p = s, g = i, b = t + l * s, m = e + o * i, A = t + (l + d) * s, _ = e + (o + h) * i;
        break;
      case 180:
        y = E._rescale, u = t + s, f = e, p = -s, g = i, b = t + (1 - o - h) * s, m = e + l * i, A = t + (1 - o) * s, _ = e + (l + d) * i;
        break;
      case 270:
        y = E._rescaleAndSwap, u = t + s, f = e + i, p = -s, g = -i, b = t + (1 - l - d) * s, m = e + (1 - o - h) * i, A = t + (1 - l) * s, _ = e + (1 - o) * i;
        break;
    }
    for (const {
      line: v,
      ...
      r.push(y(v, u, f, p, g, n ? new Array(v.length) : null)), a.push(y(S, u, f, p, g, n ? new Array(S.length) : null));
    return {
      lines: r,
      points: a,
      rect: [b, m, A, _]
  ...
  static deserialize(t, e, s, i, n, {
    ...
    if (!r) {
      ...
      for (const m of a) {
        ...
        const _ = new Float32Array(3 * (A - 2));
        r.push(_);
        let [y, v, S, w] = m.subarray(0, 4);
        _.set([NaN, NaN, NaN, NaN, y, v], 0);
        for (let T = 4; T < A; T += 2) {
          const M = m[T], B = m[T + 1];
          _.set(E.createBezierPoints(y, v, S, w, M, B), (T - 2) * 3), [y, v, S, w] = [S, w, M, B];
        }
      }
    }
    for (let m = 0, A = r.length; m < A; m++)
      h.push({
        line: g(r[m].map((_) => _ ?? NaN), d, u, f, p),
        points: g(a[m].map((_) => _ ?? NaN), d, u, f, p)
      });
    const b = new Ae();
  ...
  #h(t = this.#c) {
    ...
    return this.#o % 180 === 0 ? [e / this.#r, e / this.#n] : [e / this.#n, e / this.#r];
  }
  #u() {
  ...
  #f(t) {
    const [e, s] = this.#h();
    this.#c = t;
    const [i, n] = this.#h(), [r, a] = [i - e, n - s], o = this.#t;
  ...
  get viewBox() {
    return this.#t.map(E.svgRound).join(" ");
  }
  ...
  getPathResizedSVGProperties([t, e, s, i]) {
    ...
    if (a[0] = t, a[1] = e, a[2] = s, a[3] = i, Math.abs(h - n) <= E.PRECISION || Math.abs(d - r) <= E.PRECISION) {
      ...
      for (const {
        ...
        E._translate(A, b, m, A), E._translate(_, b, m, _);
      return {
        root: {
          viewBox: this.viewBox
        },
    ...
    if (u !== 1 || f !== 1 || p !== 0 || g !== 0)
      for (const {
        ...
        E._rescale(b, p, g, u, f, b), E._rescale(m, p, g, u, f, m);
    return {
      root: {
        viewBox: this.viewBox
      },
  ...
  getPathTranslatedSVGProperties([t, e], s) {
    ...
    if (this.#r === i && this.#n === n)
      for (const {
        line: l,
        points: h
      } of this.#i)
        E._translate(l, a, o, l), E._translate(h, a, o, h);
    else {
      ...
      for (const {
        ...
        E._rescale(d, a, o, l, h, d), E._rescale(u, a, o, l, h, u);
      r[2] *= l, r[3] *= h;
    }
    return r[0] = t, r[1] = e, {
      root: {
...
class qe extends k {
  ...
  static initialize(t, e) {
    R.initialize(t, e), this._defaultDrawingOptions = new Xe(e.viewParameters);
  }
  static getDefaultDrawingOptions(t) {
  ...
  static get typesMap() {
    return F(this, "typesMap", /* @__PURE__ */ new Map([[O.INK_THICKNESS, "stroke-width"], [O.INK_COLOR, "stroke"], [O.INK_OPACITY, "stroke-opacity"]]));
  }
  static createDrawerInstance(t, e, s, i, n) {
  ...
  createDrawingOptions({
    ...
    this._drawingOptions = qe.getDefaultDrawingOptions({
  ...
  serialize(t = !1) {
    ...
    const {
      ...
      annotationType: L.INK,
      color: R._colorManager.convert(n),
      opacity: r,
      thickness: a,
      paths: {
        lines: e,
...
class Ye extends R {
  ...
  static get supportedTypes() {
    return F(this, "supportedTypes", ["apng", "avif", "bmp", "gif", "jpeg", "png", "svg+xml", "webp", "x-icon"].map((e) => `image/${e}`));
  }
  ...
  #f() {
    ...
    t.type = "file", t.accept = Ye.supportedTypesStr;
  ...
  copyCanvas(t, e, s = !1) {
    ...
    if (e) {
      ...
      const m = 15, A = m * r.sx, _ = m * r.sy, y = new OffscreenCanvas(A * 2, _ * 2), v = y.getContext("2d");
      v.fillStyle = g, v.fillRect(0, 0, A * 2, _ * 2), v.fillStyle = b, v.fillRect(0, 0, A, _), v.fillRect(A, _, A, _), p.fillStyle = p.createPattern(y, "repeat"), p.fillRect(0, 0, u, f), p.drawImage(a, 0, 0, a.width, a.height, 0, 0, u, f);
    }
    let d = null;
    if (s) {
      let u, f;
  ...
  #m() {
    const [t, e] = this.parentDimensions, {
      width: s,
      height: i
    } = this, n = new Pe(), r = Math.ceil(s * t * n.sx), a = Math.ceil(i * e * n.sy), o = this.#l;
  ...
  static async deserialize(t, e, s) {
    ...
    if (t instanceof zs) {
      ...
      } = t, v = _.querySelector("canvas"), S = s.imageManager.getFromCanvas(_.id, v);
      v.remove();
      const w = (await e._structTree.getAriaAttributes(`${Fe}${b}`))?.get("aria-label") || "";
      i = t = {
  ...
  serialize(t = !1, e = null) {
    ...
    if (t)
      return s.bitmapUrl = this.#g(!0), s.accessibilityData = this.serializeAltText(!0), s;
    const {
      decorative: i,
      altText: n
    ...
    if (s.id = this.annotationElementId, e === null)
      return s;
...
class xt {
  ...
  static #p = new Map([Q, qe, Ye, j].map((t) => [t._editorType, t]));
  constructor({
    uiManager: t,
    pageIndex: e,
    div: s,
  ...
  get isInvisible() {
    return this.isEmpty && this.#a.getMode() === L.NONE;
  }
  updateToolbar(t) {
  ...
  async enable() {
    ...
    for (const s of this.#n.values())
      s.enableEditing(), s.show(!0), s.annotationElementId && (this.#a.removeChangedExistingAnnotation(s), t.add(s.annotationElementId));
    if (!this.#s) {
      this.#c = !1;
      return;
    }
    ...
    for (const s of e) {
      if (s.hide(), this.#a.isDeletedAnnotationElement(s.data.id) || t.has(s.data.id))
        continue;
  ...
  disable() {
    ...
    if (this.#s) {
      ...
      for (const n of i) {
        ...
        if (this.#a.isDeletedAnnotationElement(r))
          continue;
        let a = e.get(r);
        if (a) {
  ...
  #m(t) {
    ...
    if (e === this.#d.div || (e.getAttribute("role") === "img" || e.classList.contains("endOfContent")) && this.#d.div.contains(e)) {
      ...
      if (t.button !== 0 || t.ctrlKey && s)
        return;
      this.#a.showAllEditors("highlight", !0, !0), this.#d.div.classList.add("free"), this.toggleDrawing(), j.startHighlighting(this, this.#a.direction === "ltr", {
        target: this.#d.div,
        x: t.x,
        y: t.y
  ...
  changeParent(t) {
    t.parent !== this && (t.parent && t.annotationElementId && (this.#a.addDeletedAnnotationElement(t.annotationElementId), R.deleteAnnotationElement(t), t.annotationElementId = null), this.attach(t), t.parent?.detach(t), t.setParent(this), t.div && t.isAttachedToDOM && (t.div.remove(), this.div.append(t.div)));
  }
  add(t) {
  ...
  get #g() {
    return xt.#p.get(this.#a.getMode());
  }
  combinedSignal(t) {
  ...
  pasteEditor(t, e) {
    ...
    const {
      offsetX: s,
      offsetY: i
    } = this.#y(), n = this.getNextId(), r = this.#b({
      parent: this,
      id: n,
      x: s,
      y: i,
  ...
  async deserialize(t) {
    return await xt.#p.get(t.annotationType ?? t.annotationEditorType)?.deserialize(t, this, this.#a) || null;
  }
  ...
  #y() {
    const {
      ...
      width: s,
      height: i
    } = this.div.getBoundingClientRect(), n = Math.max(0, t), r = Math.max(0, e), a = Math.min(window.innerWidth, t + s), o = Math.min(window.innerHeight, e + i), l = (n + a) / 2 - t, h = (r + o) / 2 - e, [d, u] = this.viewport.rotation % 180 === 0 ? [l, h] : [h, l];
    return {
      offsetX: d,
      offsetY: u
    };
  ...
  addNewEditor() {
    this.createAndAddNewEditor(this.#y(), !0);
  }
  setSelected(t) {
  ...
  pointerdown(t) {
    if (this.#a.getMode() === L.HIGHLIGHT && this.enableTextSelection(), this.#l) {
      this.#l = !1;
      return;
    }
    const {
  ...
  render({
    ...
    for (const e of this.#a.getEditors(this.pageIndex))
...
class nt {
  ...
  draw(t, e = !1, s = !1) {
    const i = this.#e++, n = this.#n(), r = nt._svgFactory.createElement("defs");
    n.append(r);
    ...
    const l = s ? this.#l(r, o) : null, h = nt._svgFactory.createElement("use");
  ...
  drawOutline(t, e) {
    const s = this.#e++, i = this.#n(), n = nt._svgFactory.createElement("defs");
    i.append(n);
    ...
    let o;
    if (e) {
      const d = nt._svgFactory.createElement("mask");
  ...
  updateProperties(t, e) {
    ...
    const {
      ...
      rootClass: n,
      path: r
    } = e, a = typeof t == "number" ? this.#s.get(t) : t;
    if (a) {
      if (s && this.#o(a, s), i && nt.#r(a, i), n) {
        const {
          classList: o
        } = a;
...
var Vn = I.AbortException, Wn = I.AnnotationEditorLayer, Xn = I.AnnotationEditorParamsType, qn = I.AnnotationEditorType, Yn = I.AnnotationEditorUIManager, Kn = I.AnnotationLayer, Qn = I.AnnotationMode, Jn = I.ColorPicker, Zn = I.DOMSVGFactory, tr = I.DrawLayer, er = I.FeatureTest, sr = I.GlobalWorkerOptions, ir = I.ImageKind, nr = I.InvalidPDFException, rr = I.MissingPDFException, ar = I.OPS, or = I.OutputScale, lr = I.PDFDataRangeTransport, hr = I.PDFDateString, cr = I.PDFWorker, dr = I.PasswordResponses, ur = I.PermissionFlag, fr = I.PixelsPerInch, pr = I.RenderingCancelledException, gr = I.TextLayer, mr = I.TouchManager, br = I.UnexpectedResponseException, Ar = I.Util, _r = I.VerbosityLevel, yr = I.XfaLayer, vr = I.build, wr = I.createValidAbsoluteUrl, Sr = I.fetchData, Er = I.getDocument, xr = I.getFilenameFromUrl, Cr = I.getPdfFilenameFromUrl, Tr = I.getXfaPageViewport, Pr = I.isDataScheme, kr = I.isPdfFile, Rr = I.noContextMenu, Mr = I.normalizeUnicode, Ir = I.setLayerDimensions, Lr = I.shadow, Dr = I.stopEvent, Fr = I.version;
export {
  Vn as AbortException,
  Wn as AnnotationEditorLayer,
  Xn as AnnotationEditorParamsType,
  qn as AnnotationEditorType,
  Yn as AnnotationEditorUIManager,
  Kn as AnnotationLayer,
  Qn as AnnotationMode,
  Jn as ColorPicker,
  Zn as DOMSVGFactory,
  tr as DrawLayer,
  er as FeatureTest,
  sr as GlobalWorkerOptions,
  ir as ImageKind,
  nr as InvalidPDFException,
  rr as MissingPDFException,
  ar as OPS,
  or as OutputScale,
  lr as PDFDataRangeTransport,
  hr as PDFDateString,
  cr as PDFWorker,
  dr as PasswordResponses,
  ur as PermissionFlag,
  fr as PixelsPerInch,
  pr as RenderingCancelledException,
  gr as TextLayer,
  mr as TouchManager,
  br as UnexpectedResponseException,
  Ar as Util,
  _r as VerbosityLevel,
  yr as XfaLayer,
  vr as build,
  wr as createValidAbsoluteUrl,
  Sr as fetchData,
  Er as getDocument,
  xr as getFilenameFromUrl,
  Cr as getPdfFilenameFromUrl,
  Tr as getXfaPageViewport,
  Pr as isDataScheme,
  kr as isPdfFile,
  Rr as noContextMenu,
  Mr as normalizeUnicode,
  Ir as setLayerDimensions,
  Lr as shadow,
  Dr as stopEvent,
  Fr as version
};
