(function bootstrapBESPlatformControl() {
  ...
  var VERSION = '10.88.0';
  var STORAGE_KEY = 'bes-platform-control-v10880';
  var DISABLED_KEY = 'bes-platform-disabled-modules-v10880';
  var MANIFESTS = {
    release: '/bes-release-v10.88.0.json',
    modules: '/bes-modules-v10.88.0.json',
    flags: '/bes-feature-flags-v10.88.0.json',
    migrations: '/bes-migrations-v10.88.0.json',
    build: '/bes-platform-build-v10.88.0.json',
    ...
    root.querySelectorAll('[data-action]').forEach(function (node) {
      ...
      node.addEventListener('click', function (event) {
        ...
        if (action === 'copy-commands') {
          copyText('npm run verify:v10.88\nnpm run platform:doctor\nnpm run release:guard');
