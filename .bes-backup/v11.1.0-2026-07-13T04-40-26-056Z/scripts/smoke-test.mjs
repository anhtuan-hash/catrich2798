...
add('V10.81.9 JSZip declared directly', packageSource.dependencies?.jszip === '^3.10.1' && /^(?:10\.(?:8[2-9]|9\d)|11\.0)\./.test(packageSource.version), 'PPTX parser dependency is production-safe');
