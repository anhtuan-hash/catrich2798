(function bootstrapBESPlatformControl() {
  ...
  var VERSION = '10.96.0';
  var STORAGE_KEY = 'bes-platform-control-v10960';
  var DISABLED_KEY = 'bes-platform-disabled-modules-v10960';
  var MANIFESTS = {
    release: '/bes-release-v10.96.0.json',
    modules: '/bes-modules-v10.96.0.json',
    flags: '/bes-feature-flags-v10.96.0.json',
    migrations: '/bes-migrations-v10.96.0.json',
    build: '/bes-platform-build-v10.96.0.json',
  ...
  function runDiagnostics() {
    ...
    var duplicateCss = document.querySelectorAll('link[href*="bes-platform-control-v10960.css"]').length;
    var duplicateJs = document.querySelectorAll('script[src*="bes-platform-control-v10960.js"]').length;
