(function bootstrapBESPlatformControl() {
  ...
  var VERSION = '10.93.0';
  var STORAGE_KEY = 'bes-platform-control-v10930';
  var DISABLED_KEY = 'bes-platform-disabled-modules-v10930';
  var MANIFESTS = {
    release: '/bes-release-v10.93.0.json',
    modules: '/bes-modules-v10.93.0.json',
    flags: '/bes-feature-flags-v10.93.0.json',
    migrations: '/bes-migrations-v10.93.0.json',
    build: '/bes-platform-build-v10.93.0.json',
