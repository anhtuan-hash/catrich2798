(function bootstrapBESPlatformControl() {
  ...
  var VERSION = '10.95.0';
  var STORAGE_KEY = 'bes-platform-control-v10950';
  var DISABLED_KEY = 'bes-platform-disabled-modules-v10950';
  var MANIFESTS = {
    release: '/bes-release-v10.95.0.json',
    modules: '/bes-modules-v10.95.0.json',
    flags: '/bes-feature-flags-v10.95.0.json',
    migrations: '/bes-migrations-v10.95.0.json',
    build: '/bes-platform-build-v10.95.0.json',
  ...
  function runDiagnostics() {
    ...
    var duplicateCss = document.querySelectorAll('link[href*="bes-platform-control-v10950.css"]').length;
    var duplicateJs = document.querySelectorAll('script[src*="bes-platform-control-v10950.js"]').length;
