...
const copy = {
  vi: {
    ...
    library: 'Thư viện', 'resource-library': 'Kho học liệu', 'knowledge-hub': 'Kho thông minh', 'work-hub': 'Công việc', 'ai-workspace': 'AI Workspace', 'content-factory': 'Content Factory', 'assessment-core': 'Assessment', 'learning-intelligence': 'Phân tích học tập', resources: 'Tài nguyên', contact: 'Liên hệ', admin: 'Quản trị',
  ...
  en: {
    ...
    library: 'Library', 'resource-library': 'Resources Hub', 'knowledge-hub': 'Smart Knowledge', 'work-hub': 'Work Hub', 'ai-workspace': 'AI Workspace', 'content-factory': 'Content Factory', 'assessment-core': 'Assessment', 'learning-intelligence': 'Learning Intelligence', resources: 'Resources', contact: 'Contact', admin: 'Admin',
...
const routeColors = {
  ...
  library: '#6fba7b', 'resource-library': '#2878d0', 'knowledge-hub': '#315fc4', 'work-hub': '#14866d', 'ai-workspace': '#6255d9', 'content-factory': '#ef7a42', 'assessment-core': '#cc7621', 'learning-intelligence': '#1a7d73', resources: '#d99a1e', contact: '#00a6a6', admin: '#d13438',
  settings: '#123c69', qa: '#123c69', 'ai-governance': '#6d45c6', trash: '#a43b57', login: '#191515',
};

const routeIcons = {
  home: '⌂', apps: '▦', news: '▤', games: '◈', department: '▦', homeroom: '♙', library: '▤', 'resource-library': '▥', 'knowledge-hub': 'K', 'work-hub': 'WH', 'ai-workspace': 'AI', 'content-factory': 'CF', 'assessment-core': 'AC', 'learning-intelligence': 'LI',
  resources: '▦', contact: '✉', admin: '☼', settings: '⚙', qa: '♥', 'ai-governance': 'AI', trash: '⌫', login: '↪',
};

const ROUTE_KEYS = ['home', 'apps', 'news', 'games', 'department', 'homeroom', 'library', 'resource-library', 'knowledge-hub', 'work-hub', 'ai-workspace', 'content-factory', 'assessment-core', 'learning-intelligence', 'resources', 'contact', 'admin', 'settings', 'qa', 'ai-governance', 'trash'];
...
export default function GlobalFlatNavigation({
  ...
  const drawerEntries = useMemo(() => {
    const baseIds = [...entries.map((entry) => entry.id), 'route:library', 'route:resource-library', 'route:knowledge-hub', 'route:work-hub', 'route:ai-workspace', 'route:content-factory', 'route:assessment-core', 'route:learning-intelligence', 'route:trash', 'route:settings'];
