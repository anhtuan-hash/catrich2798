...
test('desktop ignores and clears the retired stored mobile-preview override', async ({ page }, testInfo) => {
  test.skip(testInfo.project.name !== 'chromium-desktop');
  ...
  await expect(page.locator('.bes-mobile-desktop-return')).toHaveCount(0);
