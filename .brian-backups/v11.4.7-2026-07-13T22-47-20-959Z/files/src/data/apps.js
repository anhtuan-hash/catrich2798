...
export const APPS = [
    ...
    },
  {
      ...
      desc: 'Build contextualised grammar explanations, controlled practice, exam-style exercises and answer keys.',
      descVi: 'Tạo lí thuyết ngữ pháp theo ngữ cảnh, bài luyện có kiểm soát, bài tập kiểu đề thi và đáp án.',
      status: 'Grammar practice · AI',
      statusVi: 'Luyện ngữ pháp · AI',
      api: true,
      featured: true,
    },
  {
