...
export default function App() {
  ...
  const exportReport = (format, report = reports[0]) => {
    const title = report?.title || 'Báo cáo hoạt động Tổ chuyên môn';
