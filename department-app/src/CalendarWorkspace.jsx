...
function normalizeEvent(event) {
  return {
    ...
    location: event.location || 'Phòng Tổ chuyên môn',
...
export const createDefaultCalendarEvents = () => [
  { id: 1, title: 'Họp tổ chuyên môn tháng 8', type: 'Họp tổ', dateISO: relativeDate(2), startTime: '08:00', endTime: '09:30', location: 'Phòng Tổ chuyên môn', attendees: ['Toàn tổ'], description: 'Thống nhất kế hoạch tháng và phân công nhiệm vụ.', reminder: 30, attachments: [] },
