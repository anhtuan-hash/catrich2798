...
import { DesignLanguageProvider, getUiLayout, UnifiedShellChrome, useDesignLanguage } from './ui-core/index.js';
...
function App() {
  ...
  return (
    ...
    >
      {!['homeroom-portal', 'classroom-join'].includes(currentRoute) ? (
        <UnifiedShellChrome
          language={language}
          status={<Suspense fallback={null}><StatusMenuBar route={currentRoute} {...context} /></Suspense>}
          navigation={(
          ...
          workspace={currentUser && canAccessRoute && !['login', 'register', 'setup'].includes(currentRoute) ? (
