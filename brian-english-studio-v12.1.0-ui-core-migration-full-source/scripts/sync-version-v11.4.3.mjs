...
Object.assign(versionFile, shared, { releaseName:'Vercel Hobby Function Consolidation' });
...
Object.assign(release, shared, { release:'Vercel Hobby Function Consolidation', runtime:'2.4.3', schema:'11.4.2' });
