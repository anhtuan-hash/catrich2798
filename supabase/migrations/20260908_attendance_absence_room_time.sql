-- 2026-09-08: rich attendance snapshots for room/time and structured absence reasons.
-- Additive rollout: keep legacy RPC signatures until the new frontend is live.
...
begin
  ...
  where not exists (
    ...
    where m.class_id = p_class_id
      and m.active = true
      and m.member_key = trim(x.member_key)
  );
