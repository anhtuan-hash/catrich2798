export const APPS = [
  {
    slug: 'department-workspace', icon: 'TC', tone: 'purple', group: 'School Management', groupVi: 'Quản lý chuyên môn',
    title: 'Department Workspace', titleVi: 'Tổ chuyên môn',
    desc: 'A role-aware workspace for department plans, tasks, meetings, teacher dossiers, evidence and reports.',
    descVi: 'Không gian điều hành kế hoạch, giao việc, sinh hoạt tổ, hồ sơ giáo viên, minh chứng và báo cáo theo vai trò.',
    status: 'Option D · Interactive prototype', statusVi: 'Phương án D · Bản tương tác', api: false, featured: true,
  },
  {
  ...
  },
  {
    ...
    status: 'Google Drive · Collections', statusVi: 'Google Drive · Bộ sưu tập', api: true, featured: true,
  },
  {
  ...
  },
  {
    ...
    status: '4-step flow · Offline', statusVi: 'Quy trình 4 bước · Offline', api: true, featured: true,
  },
  {
    ...
    status: 'Manual · Offline', statusVi: 'Thủ công · Offline', api: true,
  },
  {
    slug: 'reading-studio', icon: 'RD', tone: 'orange', group: 'Skills', groupVi: 'Kĩ năng',
    title: 'Reading Studio', titleVi: 'Reading Studio',
    desc: 'Create passages, MCQs, summaries and vocabulary support.',
    descVi: 'Tạo bài đọc, MCQ, tóm tắt và từ vựng hỗ trợ.',
    status: 'Manual · Offline', statusVi: 'Thủ công · Offline', api: true, featured: true,
  },
  {
  ...
  {
    slug: 'student-practice', icon: 'LS', tone: 'pink', group: 'Teaching Design', groupVi: 'Hỗ trợ dạy',
    title: 'Learner Sprint', titleVi: 'Learner Sprint',
    desc: 'Turn bank questions into scored practice.',
    descVi: 'Tạo bài luyện tập có chấm điểm từ ngân hàng câu hỏi.',
    status: 'Manual · Offline', statusVi: 'Thủ công · Offline', api: true, featured: true,
  },
  {
    slug: 'textcare', icon: 'TC', tone: 'red', group: 'Document Tools', groupVi: 'Văn bản',
...
export const ARCHIVED_APPS = [
  'QuizForge AI', 'WordForm Forge', 'GapCraft Builder', 'Teacher Tools Hub', 'Activity Tiles', 'FormFlow AI',
  'ExamSmith AI', 'THPT Item Lab', 'ReadSpark MCQ', 'TalkDeck Prompts', 'WriteMirror', 'TextOptimus Reader',
  'Mystery Tiles', 'Sprint Arena', 'SpinBurst', 'Link Clash', 'Rubric Foundry', 'Exam Weaver', 'Prompt Vault',
  'Blueprint Grid', 'ModelTest Planner', 'TryHard Exam Lab', 'SpeakEasy Coach', 'SkillCheck AI', 'Syntax Tree Studio',
  'PromptChef', 'BookTranslate Studio', 'BookOCR Clean', 'ArticleAudio Studio', 'PDFClear Clean',
];
