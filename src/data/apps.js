...
export const APPS = [
  {
    ...
    target: '#/tool/textlab-template-library',
    icon: 'TL',
    tone: 'blue',
    group: 'Teaching Design',
    groupVi: 'Tạo học liệu',
    title: 'Brian TextLab',
    titleVi: 'Brian TextLab',
    desc: 'Choose from 36 templates, preview activities live and export interactive offline HTML.',
    descVi: 'Chọn 36 mẫu, xem trước trực tiếp và xuất HTML tương tác chạy ngoại tuyến.',
    status: '36 templates · Offline HTML',
    statusVi: '36 mẫu · HTML ngoại tuyến',
    api: false,
    featured: true,
  ...
  },
  {
    ...
    title: 'Personnel',
    titleVi: 'Nhân sự',
    desc: 'Manage English-department staff, assignments, leave, tasks, attendance and professional records.',
    descVi: 'Quản lý nhân sự Tổ Tiếng Anh, phân công, nghỉ phép, nhiệm vụ, chấm công và hồ sơ chuyên môn.',
    status: 'English Department · Offline-first',
    statusVi: 'Tổ Tiếng Anh · Ngoại tuyến',
    api: false,
    featured: true,
    publicToAuthenticated: true,
    hideable: false,
