export const APPS = [
  ...
  },
  {
    ...
    descVi: 'Quản lí thành viên tổ, phân công, hồ sơ chuyên môn, nghỉ–vắng, đánh giá và báo cáo bằng tài khoản giáo viên đã được duyệt.',
    status: 'Department head · Linked accounts', statusVi: 'Dành cho TTCM · Liên kết tài khoản',
  ...
  },
  {
    ...
    desc: 'Create passages, MCQs, summaries and vocabulary support.', descVi: 'Tạo bài đọc, MCQ, tóm tắt và từ vựng hỗ trợ.',
  ...
  },
  {
    ...
    desc: 'Turn bank questions into scored practice.', descVi: 'Tạo bài luyện tập có chấm điểm từ ngân hàng câu hỏi.',
    status: 'Manual · Offline', statusVi: 'Thủ công · Offline', api: true, featured: true,
  },
  {
