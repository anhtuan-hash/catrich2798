...
export const APPS = [
...

  {
      ...
      desc: 'Create professional ID portraits, analyze photo quality, edit backgrounds and outfits with OpenRouter AI, then export exact-size photos and print sheets.',
      descVi: 'Tạo ảnh thẻ chuyên nghiệp, phân tích chất lượng ảnh, đổi nền – trang phục bằng OpenRouter AI và xuất ảnh đúng kích thước hoặc tờ in 10 × 15 cm.',
      status: 'OpenRouter Image · Print studio',
      statusVi: 'OpenRouter hình ảnh · Studio in',
      api: true,
      featured: true,
    },
    ...
    },
  {
      ...
      status: 'Process Workbench V2 · AI',
      statusVi: 'Process Workbench V2 · AI',
      api: true,
      featured: true,
    },
  {
