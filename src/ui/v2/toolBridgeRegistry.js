export const V2_TOOL_BRIDGE = {
  ...
  'top-five-arena': { label: 'Top Five Arena', family: 'game', tone: 'green', tested: true, fullscreen: true, level: 2 },
  ...
  'word2graph': { label: 'WordGraph Studio', family: 'authoring', tone: 'cyan', tested: true, level: 2 },
  'vietnam-tax': { label: 'Vietnam Tax Studio', family: 'utility', tone: 'blue', tested: true, level: 2 },
  'textcare': { label: 'TextCare Fixer', family: 'utility', tone: 'red', tested: true, level: 2 },
};
