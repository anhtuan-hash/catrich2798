export const V2_TOOL_BRIDGE = {
  ...
  'textlab-activities': { label: 'Brian TextLab Activities', family: 'authoring', tone: 'blue', tested: true, level: 1 },
  'exam-studio': { label: 'Exam Studio', family: 'assessment', tone: 'violet', tested: true, level: 2 },
  'lesson-plan-ai': { label: 'Lesson Architect', family: 'authoring', tone: 'blue', tested: true, level: 1 },
  'thpt-practice-hub': { label: 'THPT Interactive Practice Hub', family: 'assessment', tone: 'orange', tested: true, level: 1 },
  'seating-chart-studio': { label: 'Seating Chart Studio', family: 'classroom', tone: 'green', tested: true, level: 1 },
  'reading-studio': { label: 'Reading Studio', family: 'authoring', tone: 'orange', tested: true, level: 1 },
