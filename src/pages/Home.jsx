...
// mobile Home layout loads last, while the shared Footer styles remain the single
// visual source of truth across Home and Dashboard. The Home-only flow fix below
// only removes duplicated bottom spacing before that canonical footer.
