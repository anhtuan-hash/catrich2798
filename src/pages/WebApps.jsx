...
const APP_ORDER = [
  'hidden-apps-vault', 'resource-library-hub', 'lesson-plan-ai', 'textlab-activities',
  'news-reader', 'vietnam-tax', 'word2graph', 'textcare', 'game-hub',
  'department-workspace', 'homeroom-hub', 'library-hub', 'games-hub', 'admin-hub',
];
...
function defaultGroupOf(item) {
  ...
  if (['textlab-activities', 'news-reader', 'vietnam-tax', 'word2graph', 'game-hub', 'games-hub'].includes(item.slug)) return 'create';
  return 'manage';
}
