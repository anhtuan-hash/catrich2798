  ...
  return (
    <div className="page bes-health-page">
      ...
      <section className="bes-health-hero">
        <div>
          <span>V10.86 · AI ACTION & GOVERNANCE</span>
      ...
      <section className="bes-health-grid">
        ...
        <article className="bes-health-card">
          ...
          <div className="bes-health-card-actions">
            ...
            {currentUser?.role === 'admin' ? <button type="button" onClick={() => { window.location.hash = '#/ai-governance'; }}>{language === 'vi' ? 'Mở quản trị AI' : 'Open AI Governance'}</button> : null}
          </div>
        </article>
