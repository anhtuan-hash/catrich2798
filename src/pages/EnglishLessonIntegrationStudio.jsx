  ...
  useEffect(() => {
    ...
    const boot = async () => {
      ...
      try {
        ...
        const nativeAiConfigured = activeAI.serverManaged === true && activeAI.configured !== false;
        ...
        const hostContext = {
          ...
          ai: {
            provider: 'openrouter',
            providerLabel: 'OpenRouter · Server Gateway',
            model: activeAI.model || 'server-managed',
            ...
            request: nativeAiConfigured ? async (payload) => {
              ...
              const text = await callAI({
                ...
                profile: 'teaching-content',
                clientLabel: 'English Lesson Integration Studio',
                loadingLabel: language === 'vi' ? 'AI Copilot đang phân tích giáo án…' : 'AI Copilot is analyzing the lesson…',
              });
              return { text, provider: 'openrouter', model: activeAI.model || 'server-managed' };
            } : undefined,
          },
