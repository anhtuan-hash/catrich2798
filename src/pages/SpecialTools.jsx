    ...
    <div className="page narrow">
      ...
      {tools.length ? (
        ...
        <section className="metro-panel empty-state">
          ...
          <p>{language === 'vi' ? 'Các công cụ đang hoạt động hiện nằm trong lưới Ứng dụng để giáo viên mở nhanh hơn.' : 'Active tools now appear in the Apps grid for faster access.'}</p>
