...
const ROUTES = [
  ...
  ['ai-workspace', 'Không gian AI', 'AI Workspace', 'AI', '#6255D9'],
  ['content-factory', 'Xưởng tạo học liệu', 'Content Factory', 'CF', '#EF7A42'],
  ['content-ecosystem', 'Hệ sinh thái nội dung', 'Content Ecosystem', 'CE', '#315FC4'],
  ['lesson-pack', 'Gói bài dạy', 'Lesson Pack', 'LP', '#315FC4'],
  ['classroom-delivery', 'Điều phối lớp học', 'Classroom Delivery', 'CD', '#235FBD'],
  ['assessment-core', 'Ngân hàng câu hỏi', 'Assessment Core', 'AC', '#CC7621'],
  ['learning-intelligence', 'Phân tích học tập', 'Learning Intelligence', 'LI', '#1A7D73'],
  ['collaboration-hub', 'Không gian cộng tác', 'Collaboration Hub', 'CH', '#315FC4'],
  ...
  ['automation-center', 'Trung tâm tự động hóa', 'Automation Center', 'AU', '#1269B0'],
