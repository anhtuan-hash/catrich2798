...
export async function initializeDepartmentCloud() {
  ...
  if (!accessToken) {
    return {
      ...
      canManage: false,
      message: 'Đã bật Supabase cho Hub Chuyên môn nhưng chưa nhận được phiên đăng nhập Brian.',
    };
  }
  ...
  try {
    ...
    if (!membership) {
      return {
        ...
        accessToken,
        canManage: false,
        message: 'Tài khoản này chưa được thêm vào danh sách thành viên Hub Chuyên môn.',
      };
    }
