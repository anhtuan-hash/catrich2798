...
async function callOpenRouterProvider({
  ...
  return {
    ...
    meta: {
      ...
      fastFreeMode: Boolean(payload?.fastFreeMode),
      fastFreePrimaryUsed: Boolean(payload?.fastFreePrimaryUsed),
      fastFreeSelectedModel: String(payload?.fastFreeSelectedModel || ''),
