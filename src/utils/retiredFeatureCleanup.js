...
const RETIRED_APP_ROUTES = new Set([
  ...
  'tool/word2graph',
  'wordgraph-studio',
  'tool/wordgraph-studio',
  'student-practice',
  'tool/student-practice',
  'learner-sprint',
  'tool/learner-sprint',
  'reading-studio',
  'tool/reading-studio',
  'assessment-core',
  'tool/assessment-core',
  'flying-words',
  'tool/flying-words',
  'random-group',
  'tool/random-group',
  ...
  'tool/group-maker',
  'classroom-screen',
  'tool/classroom-screen',
  'content-ecosystem',
  'tool/content-ecosystem',
  'automation-center',
  'tool/automation-center',
  'collaboration-hub',
  'tool/collaboration-hub',
  'knowledge-train',
  'tool/knowledge-train',
  'word-orbit',
  'tool/word-orbit',
  'activity-graph',
  'tool/activity-graph',
  'crossword-trial',
  'tool/crossword-trial',
]);
