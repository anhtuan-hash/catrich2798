...
export const AI_PROMPT_REGISTRY = Object.freeze({
  ...
  'textlab.generateActivity': task({ id: 'textlab.generateActivity', app: 'TextLab Activities', label: 'Tạo hoạt động tương tác', group: 'teaching-content', governanceProfile: 'worksheet', routingHint: 'smart', maxOutputTokens: 2200, temperature: 0.25, output: 'json', systemInstruction: 'Return exactly one valid JSON object. Encode line breaks inside string values as \\n and escape embedded double quotes. Never use markdown fences.', validation: jsonContract(['templateId', 'content']), version: '1.4.0' }),
