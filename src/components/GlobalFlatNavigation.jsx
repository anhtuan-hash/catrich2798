...
const routeColors = {
  ...
  library: '#6fba7b', 'resource-library': '#2878d0', 'knowledge-hub': '#315fc4', 'work-hub': '#14866d', 'assessment-core': '#cc7621', 'platform-readiness': '#0f766e', 'automation-center': '#1269b0', 'cloud-operations': '#167b68', 'collaboration-hub': '#315fc4', 'data-governance': '#a24b35', resources: '#d99a1e', contact: '#00a6a6', admin: '#d13438', 'app-vault': '#684cc6',
  settings: '#123c69', qa: '#123c69', 'ai-governance': '#6d45c6', trash: '#a43b57', login: '#191515',
};

const routeIcons = {
  home: '⌂', apps: '▦', news: '▤', games: '◈', department: '▦', homeroom: '♙', library: '▤', 'resource-library': '▥', 'knowledge-hub': 'K', 'work-hub': 'WH', 'assessment-core': 'AC', 'platform-readiness': 'PR', 'automation-center': 'AU', 'cloud-operations': 'CO', 'collaboration-hub': 'CH', 'data-governance': 'DG',
  resources: '▦', contact: '✉', admin: '☼', 'app-vault': 'HV', settings: '⚙', qa: '♥', 'ai-governance': 'AI', trash: '⌫', login: '↪',
};

const ROUTE_KEYS = ['home', 'apps', 'news', 'games', 'department', 'homeroom', 'library', 'resource-library', 'knowledge-hub', 'work-hub', 'assessment-core', 'platform-readiness', 'automation-center', 'cloud-operations', 'collaboration-hub', 'data-governance', 'resources', 'contact', 'admin', 'app-vault', 'settings', 'qa', 'ai-governance', 'trash'];
...
export default function GlobalFlatNavigation({
  ...
  const drawerEntries = useMemo(() => {
    const baseIds = [...entries.map((entry) => entry.id), 'route:library', 'route:resource-library', 'route:knowledge-hub', 'route:work-hub', 'route:assessment-core', 'route:platform-readiness', 'route:automation-center', 'route:cloud-operations', 'route:collaboration-hub', 'route:data-governance', 'route:trash', 'route:settings'];
