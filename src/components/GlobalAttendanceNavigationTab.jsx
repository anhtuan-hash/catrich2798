...
export default function GlobalAttendanceNavigationTab({ currentUser }) {
  ...
  const selectedSessionAttendanceRate = selectedSession?.session_status === 'cancelled' || !Number(selectedSession?.total_students)
    ? null
