...
export function AnnouncementsTab({ workspace, onCommit, currentUser }) {
  ...
  const publish = async () => {
    setPublishing(true); const result = await publishHomeroomPortal(workspace, currentUser); setPublishing(false);
